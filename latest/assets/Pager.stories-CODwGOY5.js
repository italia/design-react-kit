...
import { D as Dropdown, a as DropdownToggle } from "./DropdownToggle-DLLsIidG.js";
import { D as DropdownMenu } from "./DropdownMenu-DSqWavxD.js";
...
const Pager = ({
  ...
  const listChildren = e.Children.toArray(children).filter((child) => child.type === PaginationItem);
  const extraChildren = e.Children.toArray(children).filter((child) => child.type !== PaginationItem);
  return /* @__PURE__ */ e.createElement(Tag, { className: classes, ...attributes, "data-testid": testId }, /* @__PURE__ */ e.createElement(ListTag, { className: listClasses }, listChildren), extraChildren, total ? /* @__PURE__ */ e.createElement("p", null, totalAriaLabel, label) : null);
};
