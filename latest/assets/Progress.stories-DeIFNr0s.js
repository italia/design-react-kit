...
import { P as Progress } from "./Progress-DHPbk47K.js";
...
const Esempio = {
  render: () => /* @__PURE__ */ e.createElement(Progress, { value: "50" })
};
const Etichette = {
  render: () => /* @__PURE__ */ e.createElement(Progress, { value: "35", label: "progresso" })
};
const ProgressoIndeterminato = {
  render: () => /* @__PURE__ */ e.createElement(Progress, { indeterminate: true, label: "In elaborazione..." })
};
const Colori = {
  render: () => /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Progress, { value: "25", color: "success" }), /* @__PURE__ */ e.createElement(Progress, { value: "33", color: "info" }), /* @__PURE__ */ e.createElement(Progress, { value: "50", color: "warning" }), /* @__PURE__ */ e.createElement(Progress, { value: "66", color: "danger" }))
};
const BottoneConProgressBar = {
  render: () => /* @__PURE__ */ e.createElement("div", { className: "container" }, /* @__PURE__ */ e.createElement("div", { className: "row" }, /* @__PURE__ */ e.createElement("div", { className: "col-12 col-sm-6" }, /* @__PURE__ */ e.createElement("p", null, /* @__PURE__ */ e.createElement("strong", null, "Bottone primario")), /* @__PURE__ */ e.createElement(Button, { color: "primary", className: "btn-progress", disabled: true }, "Label bottone ", /* @__PURE__ */ e.createElement(Icon, { color: "light", icon: "it-github", "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", null, /* @__PURE__ */ e.createElement(Progress, { value: "50" })))), /* @__PURE__ */ e.createElement("div", { className: "col-12 col-sm-6" }, /* @__PURE__ */ e.createElement("p", null, /* @__PURE__ */ e.createElement("strong", null, "Bottone secondario")), /* @__PURE__ */ e.createElement(Button, { color: "secondary", className: "btn-progress", disabled: true }, "Label bottone ", /* @__PURE__ */ e.createElement(Icon, { color: "light", icon: "it-github", "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", null, /* @__PURE__ */ e.createElement(Progress, { value: "50" }))))))
};
const _EsempiInterattivi = {
  render: ({
    ...
    return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Progress, { value, label, color }));
  },
  args: {
    color: "",
    value: 25,
