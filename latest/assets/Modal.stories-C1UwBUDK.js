...
import { e, r as reactExports } from "./iframe-BCTfBavy.js";
import { F as FormGroup } from "./FormGroup-BWKY-1o6.js";
import { L as Label } from "./Label-DBD_H2CU.js";
import { B as Button } from "./Button-CYF7XGEW.js";
import { I as Icon } from "./Icon-Ds5hBZDo.js";
import { I as Input } from "./Input-B0vZLe6d.js";
import { L as LinkList, a as LinkListItem } from "./LinkListItem-CnM5mAjk.js";
import { c as classNames } from "./index-FT2ekEOf.js";
import { P as PropTypes, f as canUseDOM, k as keyCodes, h as focusableElements, g as getTarget, j as getOriginalBodyPadding, l as conditionallyUpdateScrollbar, m as mapToCssModules, s as setScrollbarWidth, o as omit, b as targetPropType, T as TransitionTimeouts, t as tagPropType } from "./utils-C9pDOpcZ.js";
import { F as Fg } from "./index-CvNm2WlK.js";
import { F as Fade } from "./Fade-C5YMa-0s.js";
...
var Portal = /* @__PURE__ */ (function(_React$Component) {
  ...
  _createClass$1(Portal2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ Fg.createPortal(this.props.children, this.props.node || this.defaultNode);
    }
  }]);
  return Portal2;
})(e.Component);
...
var Modal$1 = /* @__PURE__ */ (function(_React$Component) {
  ...
  _createClass(Modal2, [{
    ...
    value: function renderModalDialog() {
      ...
      return /* @__PURE__ */ e.createElement("div", _extends$2({}, attributes, {
    ...
    value: function render() {
      ...
      if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
        ...
        var Backdrop = backdrop && (hasTransition ? /* @__PURE__ */ e.createElement(Fade, _extends$2({}, backdropTransition, {
          "in": isOpen && !!backdrop,
          cssModule,
        ...
        return /* @__PURE__ */ e.createElement(Portal, {
          node: this._element
        }, /* @__PURE__ */ e.createElement("div", {
          className: mapToCssModules(wrapClassName)
        }, /* @__PURE__ */ e.createElement(Fade, _extends$2({}, modalAttributes, modalTransition, {
          "in": isOpen,
...
const ModalBody = (props) => /* @__PURE__ */ e.createElement(ModalBody$1, { ...props });
...
const ModalFooter = (props) => /* @__PURE__ */ e.createElement(ModalFooter$1, { ...props });
...
const ModalHeader = ({
  ...
  let CloseButton;
  if (!close && toggle) {
    CloseButton = /* @__PURE__ */ e.createElement(
      "button",
      {
        type: "button",
        onClick: toggle,
  ...
  return /* @__PURE__ */ e.createElement(WrapTag, { ...props, className: classes }, icon != null ? /* @__PURE__ */ e.createElement(Icon, { icon }) : null, /* @__PURE__ */ e.createElement(Tag, { className: mapToCssModules$1("modal-title h5", cssModule) }, children), close || CloseButton);
};
...
const _EsempioBase = {
  render: () => /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement("div", { className: "modal-dialog", role: "document" }, /* @__PURE__ */ e.createElement(ModalHeader, null, "Titolo della modale"), /* @__PURE__ */ e.createElement(ModalBody, null, "Il testo del corpo della modale va qui."), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "secondary" }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary" }, "Salva le modifiche"))))
};
const ModaleBaseConBottoneChiusuraHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Mostra modale con bottone di chiusura"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), labelledBy: "esempio2" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio2" }, "Titolo della modale"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const ModaleBaseConBottoneChiusura = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ModaleBaseConBottoneChiusuraHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const ModaleBaseHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), labelledBy: "esempio1" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio1" }, "Titolo della modale"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const ModaleBase = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ModaleBaseHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const ModaleConIconaHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con icona"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), withIcon: true, labelledBy: "esempio3" }, /* @__PURE__ */ e.createElement(ModalHeader, { icon: "it-info-circle", id: "esempio3" }, "This is a notification message more long than usual"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "In the various types of information modal dialog, only one button to close dialog is provided.")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Ok"))));
};
const ModaleConIcona = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ModaleConIconaHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const ModaleConFormInputsHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con form"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), labelledBy: "esempio4" }, /* @__PURE__ */ e.createElement(ModalHeader, { id: "esempio4", toggle: () => toggleModal(!isOpen) }, "SCEGLI UNA OPZIONE"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement(FormGroup, { check: true }, /* @__PURE__ */ e.createElement(Input, { name: "gruppo1", type: "radio", id: "radio1", defaultChecked: true }), /* @__PURE__ */ e.createElement(Label, { check: true, htmlFor: "radio1" }, "Opzione 1")), /* @__PURE__ */ e.createElement(FormGroup, { check: true }, /* @__PURE__ */ e.createElement(Input, { name: "gruppo1", type: "radio", id: "radio2" }), /* @__PURE__ */ e.createElement(Label, { check: true, htmlFor: "radio2" }, "Opzione 2")), /* @__PURE__ */ e.createElement(FormGroup, { check: true }, /* @__PURE__ */ e.createElement(Input, { name: "gruppo1", type: "radio", id: "radio3" }), /* @__PURE__ */ e.createElement(Label, { check: true, htmlFor: "radio3" }, "Opzione 3"))), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { outline: true, color: "primary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen), disabled: true }, "Ok"))));
};
const ModaleConFormInputs = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ModaleConFormInputsHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const ModaleConLinkListHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con LinkList"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), withLinkList: true, labelledBy: "esempio5" }, /* @__PURE__ */ e.createElement(ModalHeader, { id: "esempio5" }, /* @__PURE__ */ e.createElement("span", null, "1."), "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt."), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement(LinkList, null, /* @__PURE__ */ e.createElement(LinkListItem, { className: "icon-left" }, /* @__PURE__ */ e.createElement(Icon, { color: "primary", icon: "it-chevron-right", "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", null, "Link list 1")), /* @__PURE__ */ e.createElement(LinkListItem, { className: "icon-left" }, /* @__PURE__ */ e.createElement(Icon, { color: "primary", icon: "it-chevron-right", "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", null, "Link list 2")), /* @__PURE__ */ e.createElement(LinkListItem, { className: "icon-left" }, /* @__PURE__ */ e.createElement(Icon, { color: "primary", icon: "it-chevron-right", "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", null, "Link list 3")))), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Ok"))));
};
const ModaleConLinkList = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ModaleConLinkListHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const ModalePopConfirmHooks = () => {
  ...
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleBaseModal(!isOpenBase), className: "me-3" }, "Lancia modale pop-confirm base"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModalWithHeader(!isOpenWithHeader), className: "me-3" }, "Lancia modale pop-confirm con titolo"), /* @__PURE__ */ e.createElement(Modal, { isOpen: isOpenBase, toggle: () => toggleBaseModal(!isOpenBase), popConfirm: true }, /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Font Titillium 14px. Leading 21px.")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleBaseModal(!isOpenBase), size: "sm" }, "Action one"), /* @__PURE__ */ e.createElement(Button, { color: "secondary", onClick: () => toggleBaseModal(!isOpenBase), size: "sm", outline: true }, "Action two"))), /* @__PURE__ */ e.createElement(Modal, { isOpen: isOpenWithHeader, toggle: () => toggleModalWithHeader(!isOpenWithHeader), popConfirm: true, labelledBy: "esempio6" }, /* @__PURE__ */ e.createElement(ModalHeader, { labelledBy: "esempio6" }, "Popconfirm header"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Font Titillium 14px. Leading 21px.")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModalWithHeader(!isOpenWithHeader), size: "sm" }, "Action one"), /* @__PURE__ */ e.createElement(Button, { color: "secondary", onClick: () => toggleModalWithHeader(!isOpenWithHeader), size: "sm", outline: true }, "Action two"))));
};
const ModalePopConfirm = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ModalePopConfirmHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const ScrollDiContenutiLunghiHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale scrollabile"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), labelledBy: "esempio7" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio7" }, "Titolo della modale"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement("p", null, "Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."), /* @__PURE__ */ e.createElement("p", null, "Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor."), /* @__PURE__ */ e.createElement("p", null, "Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla."), /* @__PURE__ */ e.createElement("p", null, "Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."), /* @__PURE__ */ e.createElement("p", null, "Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor."), /* @__PURE__ */ e.createElement("p", null, "Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla."), /* @__PURE__ */ e.createElement("p", null, "Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."), /* @__PURE__ */ e.createElement("p", null, "Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor."), /* @__PURE__ */ e.createElement("p", null, "Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla."), /* @__PURE__ */ e.createElement("p", null, "Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."), /* @__PURE__ */ e.createElement("p", null, "Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor."), /* @__PURE__ */ e.createElement("p", null, "Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla."), /* @__PURE__ */ e.createElement("p", null, "Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."), /* @__PURE__ */ e.createElement("p", null, "Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor."), /* @__PURE__ */ e.createElement("p", null, "Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla."), /* @__PURE__ */ e.createElement("p", null, "Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."), /* @__PURE__ */ e.createElement("p", null, "Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor."), /* @__PURE__ */ e.createElement("p", null, "Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla."))), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const ScrollDiContenutiLunghi = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ScrollDiContenutiLunghiHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const ModaleConContenutoScrollabileHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia modale con contenuto scrollabile"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), scrollable: true, labelledBy: "esempio8" }, /* @__PURE__ */ e.createElement(ModalHeader, { id: "esempio8" }, "INTESTAZIONE MODALE"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", outline: true, onClick: () => toggleModal(!isOpen), size: "sm" }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen), size: "sm" }, "Azione Uno"))));
};
const ModaleConContenutoScrollabile = {
  render: () => {
    return /* @__PURE__ */ e.createElement(ModaleConContenutoScrollabileHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const CentraturaVerticaleStoryHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), centered: true, labelledBy: "esempio9" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "essempio9" }, "Titolo della modale"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const _CentraturaVerticale = {
  render: () => {
    return /* @__PURE__ */ e.createElement(CentraturaVerticaleStoryHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const AllineamentoASinistraHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale a sinistra"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), align: "left", scrollable: true, labelledBy: "esempio10" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio10" }, "This is a notification message"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Ok"))));
};
const AllineamentoASinistra = {
  render: () => {
    return /* @__PURE__ */ e.createElement(AllineamentoASinistraHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const AllineamentoADestraHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale a destra"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), align: "right", scrollable: true, labelledBy: "esempio11" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio11" }, "This is a notification message"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Ok"))));
};
const AllineamentoADestra = {
  render: () => {
    return /* @__PURE__ */ e.createElement(AllineamentoADestraHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const RimuovereLanimazioneHooks = () => {
  const [isOpen, toggleModal] = reactExports.useState(false);
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Lancia la demo della modale"), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), fade: false, labelledBy: "esempio12" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio12" }, "Titolo della modale"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const RimuovereLanimazione = {
  render: () => {
    return /* @__PURE__ */ e.createElement(RimuovereLanimazioneHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
...
const DimensioniHooks = () => {
  ...
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => {
    setSize("lg");
    toggleModal(true);
  }, className: "me-3" }, "Modale grande"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => {
    setSize("sm");
    toggleModal(true);
  } }, "Modale piccola")), /* @__PURE__ */ e.createElement(Modal, { isOpen, toggle: () => toggleModal(!isOpen), size, labelledBy: "esempio13" }, /* @__PURE__ */ e.createElement(ModalHeader, { toggle: () => toggleModal(!isOpen), id: "esempio13" }, "Titolo della modale"), /* @__PURE__ */ e.createElement(ModalBody, null, /* @__PURE__ */ e.createElement("p", null, "Woohoo, stai leggendo questo testo in una modale!")), /* @__PURE__ */ e.createElement(ModalFooter, null, /* @__PURE__ */ e.createElement(Button, { color: "secondary", onClick: () => toggleModal(!isOpen) }, "Chiudi"), /* @__PURE__ */ e.createElement(Button, { color: "primary", onClick: () => toggleModal(!isOpen) }, "Salva modifiche"))));
};
const _Dimensioni = {
  render: () => {
    return /* @__PURE__ */ e.createElement(DimensioniHooks, null);
  },
  parameters: {
    layout: "centered",
    docs: {
