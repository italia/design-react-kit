import { i as isNumber } from "./index-mfTKDENv.js";
...
import { m as mapToCssModules, a as notifyDeprecation } from "./utils-CwYUlCuU.js";
const InputContainer = ({
  ...
  if (hasButtonRight || hasIconLeft) {
    return /* @__PURE__ */ e.createElement("div", { className: wrapperClass, "data-testid": testId }, /* @__PURE__ */ e.createElement("div", { className: "input-group" }, hasIconLeft && /* @__PURE__ */ e.createElement("span", { className: "input-group-text" }, iconLeft), /* @__PURE__ */ e.createElement("label", { htmlFor: id, className: activeClass + " " + extraLabelClass }, label), children, infoText && /* @__PURE__ */ e.createElement("small", { id: infoId, className: "form-text" }, infoText), /* @__PURE__ */ e.createElement("div", { className: validationTextClass }, validationText), hasButtonRight && /* @__PURE__ */ e.createElement("div", { className: "input-group-append" }, buttonRight)));
  }
  return /* @__PURE__ */ e.createElement("div", { className: wrapperClass, "data-testid": testId }, /* @__PURE__ */ e.createElement("label", { htmlFor: id, className: activeClass + " " + extraLabelClass }, label), children, infoText && /* @__PURE__ */ e.createElement("small", { id: infoId, className: "form-text" }, infoText), /* @__PURE__ */ e.createElement("div", { className: validationTextClass }, validationText));
};
InputContainer.__docgenInfo = { "description": "", "methods": [], "displayName": "InputContainer", "props": { "wrapperClass": { "required": true, "tsType": { "name": "string" }, "description": "" }, "activeClass": { "required": true, "tsType": { "name": "string" }, "description": "" }, "extraLabelClass": { "required": true, "tsType": { "name": "string" }, "description": "" }, "validationTextClass": { "required": true, "tsType": { "name": "string" }, "description": "" }, "label": { "required": true, "tsType": { "name": "union", "raw": "string | ReactNode | undefined", "elements": [{ "name": "string" }, { "name": "ReactNode" }, { "name": "undefined" }] }, "description": "" }, "validationText": { "required": true, "tsType": { "name": "union", "raw": "string | undefined", "elements": [{ "name": "string" }, { "name": "undefined" }] }, "description": "" }, "id": { "required": true, "tsType": { "name": "union", "raw": "string | undefined", "elements": [{ "name": "string" }, { "name": "undefined" }] }, "description": "" }, "infoId": { "required": true, "tsType": { "name": "union", "raw": "string | undefined", "elements": [{ "name": "string" }, { "name": "undefined" }] }, "description": "" }, "infoText": { "required": true, "tsType": { "name": "union", "raw": "string | undefined", "elements": [{ "name": "string" }, { "name": "undefined" }] }, "description": "" }, "hasButtonRight": { "required": false, "tsType": { "name": "boolean" }, "description": "Indica che il componente ha un bottone a destra rispetto all'input" }, "buttonRight": { "required": false, "tsType": { "name": "ReactNode" }, "description": "Componente per il bottone" }, "hasIconLeft": { "required": false, "tsType": { "name": "boolean" }, "description": "Indica che il componente ha una icona a sinistra rispetto all'input" }, "iconLeft": { "required": false, "tsType": { "name": "ReactNode" }, "description": "Componente per l'icona" }, "testId": { "required": false, "tsType": { "name": "string" }, "description": "" } }, "composes": ["HTMLAttributes"] };
...
const Input = ({
  ...
  const infoId = id && infoText ? `${id}Description` : void 0;
  if (infoId) {
  ...
  const clickIncrDecr = (mode) => {
    ...
    let step = parseFloat(((_a = inputRef.current) == null ? void 0 : _a.step) ? inputRef.current.step : "1");
    ...
    (_f = inputRef.current) == null ? void 0 : _f.dispatchEvent(ev1);
    (_g = inputRef.current) == null ? void 0 : _g.dispatchEvent(ev2);
    (_h = inputRef.current) == null ? void 0 : _h.focus();
  };
  if (["currency", "percentage", "adaptive", "number"].includes(type)) {
    ...
    return /* @__PURE__ */ e.createElement(InputContainer, { ...containerProps }, /* @__PURE__ */ e.createElement(
      "div",
      {
        ...
        style: type === "adaptive" ? { width: !value ? "70px" : `min(calc(70px + ${`${value}`.length}ch), 100%)` } : void 0
      },
      ["currency", "percentage"].includes(type) && /* @__PURE__ */ e.createElement("span", { className: "input-group-text fw-semibold" }, addonText),
      ...
      /* @__PURE__ */ e.createElement("span", { className: "input-group-text align-buttons flex-column" }, /* @__PURE__ */ e.createElement("button", { type: "button", className: "input-number-add", onClick: () => clickIncrDecr(1) }, /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, incrementLabel || "")), /* @__PURE__ */ e.createElement("button", { type: "button", className: "input-number-sub", onClick: () => clickIncrDecr(-1) }, /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, decrementLabel || "")))
    ));
  }
  if (placeholder) {
    return /* @__PURE__ */ e.createElement(InputContainer, { ...containerProps }, /* @__PURE__ */ e.createElement(
  ...
  if (inputPassword) {
    ...
    ), /* @__PURE__ */ e.createElement("span", { className: "password-icon", "aria-hidden": "true" }, /* @__PURE__ */ e.createElement(
      Icon,
      {
        size: "sm",
