...
import { A as Alert } from "./Alert-C3WVUsj2.js";
...
const _EsempiInterattivi = {
  render: ({
    ...args
  }) => /* @__PURE__ */ e.createElement(Alert, { ...args }, "Questo è un alert di ", /* @__PURE__ */ e.createElement("b", null, args.color), "!")
};
const _LinkEvidenziato = {
  render: ({
    ...args
  }) => /* @__PURE__ */ e.createElement(Alert, { ...args }, "Questo è un alert con un esempio di", " ", /* @__PURE__ */ e.createElement("a", { href: "#", className: "alert-link" }, "link")),
  args: {
    color: "danger"
  }
};
const _ContenutoAggiuntivo = {
  render: ({
    ...args
  }) => /* @__PURE__ */ e.createElement(Alert, { ...args }, /* @__PURE__ */ e.createElement("h4", { className: "alert-heading" }, "Avviso di successo!"), /* @__PURE__ */ e.createElement("p", null, "Stai leggendo questo importante messaggio di avviso di successo. Questo testo di esempio sarà più a lungo in modo da poter vedere come funzioni la spaziatura all'interno di un avviso con questo tipo di contenuto."), /* @__PURE__ */ e.createElement("hr", null), /* @__PURE__ */ e.createElement("p", { className: "mb-0" }, "Quando necessario, assicurarti di inserire le utilità di margine per mantenere gli spazi equilibrati."))
};
const ChiusuraControllataWithHooks = ({
  ...
  return /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(Alert, { ...args, isOpen: open, toggle: closeAlert }, /* @__PURE__ */ e.createElement("strong", null, "Attenzione:"), " Alcuni campi inseriti sono da controllare."));
};
const ChiusuraControllata = {
  render: (args) => /* @__PURE__ */ e.createElement(ChiusuraControllataWithHooks, { ...args }),
  parameters: {
    docs: {
      canvas: {
        sourceState: "none"
