...
ReactDOM.render(
<Button style="info" text="Button default"/>,
document.getElementById("button")
);
ReactDOM.render(
<Button style="info" text="Button default pressed" pressed={true}/>,
document.getElementById("button-pressed")
);
ReactDOM.render(
<Button style="info" text="Button default disabled" disabled={true}/>,
document.getElementById("button-disabled")
);
ReactDOM.render(
<Button style="info" text="Button default round" round={true}/>,
document.getElementById("button-round")
);
ReactDOM.render(
<Button style="info" text="Button default round shadow" round={true} shadow={true}/>,
document.getElementById("button-round-shadow")
);
ReactDOM.render(
<Button style="info" text="Link button default round shadow" shadow={true} round={true} link="#"/>,
