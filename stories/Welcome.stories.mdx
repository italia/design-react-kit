  ...
  <Row className='justify-content-md-center'>
    <Col md={10} className='my-4'>
      ...
      <p>
        ...
        e della libreria{' '}
        <a
          href='https://italia.github.io/bootstrap-italia/1.x/'
          target='_blank'
          rel='noopener noreferrer'
        >
          Bootstrap Italia v.1.x
          <i className='it-external-link' />
        </a>
        . Per iniziare, è sufficiente installare il pacchetto <Code>npm</Code> attraverso
        il seguente comando:
      </p>
      ...
      <p className='small'>
        ...
        ), un modello ancora più permissivo della classica licenza GPL, in quanto
        consente di modificare e ridistribuire questo software secondo varie modalità,
        anche di tipo closed-source.
      </p>
    </Col>
  </Row>
</Container>
