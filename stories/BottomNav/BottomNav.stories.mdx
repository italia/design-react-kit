...
<div className="docs">
    <Callout color="warning" >
        ...
        <CalloutText>
            <p>I badge e gli alert sono nascosti agli screen reader. Per garantire l’accessibilità è necessario aggiungere un attributo <code>srText</code> label che contenga un testo esplicativo.</p>
        </CalloutText>
    </Callout>
</div>
