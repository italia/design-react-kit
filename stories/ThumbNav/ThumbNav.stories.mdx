...
<div className="docs">
    <Callout color="success" >
        ...
        <CalloutText>
            <p>Per ragioni di accessibilità è importante indicare all’interno dell’attributo <code>alt=""</code> dell’immagine thumbnail l’azione associata al link relativo.</p>
        </CalloutText>
    </Callout>
</div>
