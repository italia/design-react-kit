...
<div className='docs'>
  <Callout color='info'>
    <CalloutText>
      Ogni link all’interno della Navscroll contiene l’attributo <code>href</code> con il valore dell’id relativo all’elemento correlato in pagina: <code>href="#idElemento"</code>.
    </CalloutText>
  </Callout>
</div>
