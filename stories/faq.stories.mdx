...
Se si tratta di un componente Bootstrap, probabilmente è possibile trovare maggiore documentazione sulla pagina GitHub di [reactstrap](https://github.com/reactstrap/reactstrap), cioè della libreria utilizzata da questo kit.
