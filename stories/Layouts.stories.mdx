...
<div className='docs'>
  <Callout>
    ...
    <CalloutText>
      ...
      <ul>
          <li><a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox" target="_blank">guida su flexbox su MSDN</a> (in inglese)</li>
          <li><a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/#flexbox-background" target="_blank">guida su flexbox su CSS tricks</a> (in inglese)</li>
          <li><a href="http://flexboxfroggy.com/#it" target="_blank">un simpatico quiz per verificare le tue conoscenze</a></li>
      </ul>
    </CalloutText>
  </Callout>
</div>
