...
Bootstrap Italia eredita gli stessi meccanisimi per la gestione dei colori di Bootstrap 5.3, dove i colori del tema sono descritti attraverso una variabile Sass nominata `$theme-colors`.
...
Si possono trovare maggiori informazioni a riguardo sul <a href="https://getbootstrap.com/docs/5.3/utilities/colors/" target="_blank" rel="noopener noreferrer">sito di Bootstrap</a>.
