...
Per la creazione del componente, è stato utilizzato il plugin <a target="_blank" href="https://github.com/alphagov/accessible-autocomplete" rel="noreferrer">Accessible autocomplete</a>.

Per una corretta implementazione si consiglia di consultare la <a target="_blank" href="https://alphagov.github.io/accessible-autocomplete/" rel="noreferrer">documentazione</a>.
