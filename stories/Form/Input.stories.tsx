...
export const InputConIconaOBottoni = () => (
  <div>
    <Input
      ...
      icon={<Icon icon='it-pencil' aria-hidden size='sm' />}
    />
    <Input
      type='text'
      ...
      icon={<Icon icon='it-pencil' color='danger' aria-hidden size='sm' />}
    />
    <Input
      type='text'
      ...
      icon={<Icon icon='it-pencil' color='primary' aria-hidden size='sm' />}
    />
  </div>
);
