...
In aggiunta al formato diverso è necessario passare un componente `GroupHeading` aggiuntivo al componente `Select`:

<Canvas>
    <Story id="componenti-form-select--select-con-gruppi" />
</Canvas>

L'implementazione per il componente `GroupHeading` utilizzato è la seguente:
