...
Di seguito alcuni esempi di uso del componente `Select` con i tipi Typescript.

### Select classica

<Canvas>
  <Story id='componenti-form-select--select-classica-ts' />
</Canvas>

### Select con Gruppi

<Canvas>
  <Story id='componenti-form-select--select-con-gruppi-ts' />
</Canvas>
