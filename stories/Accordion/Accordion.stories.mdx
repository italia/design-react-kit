...
<div className='docs'>
  <Callout color='success'>
    ...
    <CalloutText>
      Nell’esempio di codice ogni elemento <Code>&lt;button&gt;</Code> è
      inserito all’interno di un elemento &lt;h2&gt; (o altro livello h in
      funzione del contesto) in quanto, frequentemente, i pulsanti di azione di
      un accordion sono anche i titoli della sezione che segue.
    </CalloutText>
  </Callout>
</div>
...
<div className='docs'>
  <Callout color='success'>
    <CalloutTitle>Accessibilità</CalloutTitle>
    <CalloutText>
      Utilizzare questo approccio solo quando strettamente necessario: dal punto
      di vista dell’accessibilità non si tratta di una soluzione ottimale.
    </CalloutText>
  </Callout>
</div>
