  ...
  <div className="container">
    <div className="row justify-content-md-center">
      <div className="col-md-10 my-4">
        <h1 className="text-center">React Kit</h1>
        ...
        <p className="small text-muted text-center">
          Il kit React per la Pubblica Amministrazione
        </p>
        <p>
          React Kit è un <b>set di componenti open-source per React</b> conforme
          alle Linee guida di design per i servizi digitali della PA, costruito
          sulle basi dello{' '}
          <a
            href="https://github.com/italia/design-ui-kit"
            target="_blank"
            rel="noopener noreferrer">
            UI Kit <i className="it-external-link" />
          </a>{' '}
          e della libreria{' '}
          <a
            ...
            target="_blank"
            rel="noopener noreferrer">
            Bootstrap Italia <i className="it-external-link" />
          </a>
          . Per iniziare, è sufficiente installare il pacchetto <code>npm</code>{' '}
        ...
        <p className="small">
          ...
          <a href="https://github.com/italia/design-react-kit/blob/master/LICENSE">
            LICENSE
          </a>
