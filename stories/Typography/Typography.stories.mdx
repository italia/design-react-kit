...
<div className='docs'>
  <Callout color='success'>
    ...
    <CalloutText>
      È fondamentale evidenziare i link presenti in un paragrafo in modo
      adeguato, utilizzando la forma (grassetto, sottolineato) oltre al colore
      per indicare la presenza di un collegamento ipertestuale.
    </CalloutText>
  </Callout>
</div>
