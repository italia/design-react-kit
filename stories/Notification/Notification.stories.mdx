...
<div className='docs'>
  <Callout color='warning'>
    ...
    <CalloutText>
      Di seguito verrà utilizzato un componente <code>NotificationDoc</code>, di
      tipo statico, creato appositamente per lo scopo di questa documentazione e{' '}
      <strong>che non deve essere utilizzato</strong> nel codice ai fini di
      produzione.
    </CalloutText>
  </Callout>
</div>
