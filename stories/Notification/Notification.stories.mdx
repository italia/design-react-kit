...
import {
  NotifyFakeComponent_story_hidden,
  NotifyFakeOptionsComponent_story_hidden
...
<div className='docs'>
  <Callout color='warning'>
    <CalloutTitle>Componente statico per la documentazione</CalloutTitle>
    <CalloutText>
      <p>
        Di seguito verrà utilizzato un componente <code>NotificationDoc</code>,
        di tipo statico, creato appositamente per lo scopo di questa
        documentazione e <strong>che non deve essere utilizzato</strong> nel
        codice ai fini di produzione.
      </p>
    </CalloutText>
  </Callout>
</div>
