    ...
    return(
        <div className="container test-docs">
            <div className="row mb-5">
                <div className="col-12 col-md-6 mb-4 mb-md-0" style={{position:'fixed'}}>
                <p><strong>Basic (rounding at 4 corners)</strong></p>
            ...
            <div className="col-12 col-md-6" style={OffsetStyle}>
                    ...
                    <p style={{marginTop:'90px'}}><strong>bottom-fix</strong></p>
                    <div className="row mb-5" style={XOffsetStyle}>
                    <NotificationWithIcon
                        header="Notification Title"
                        state="success"
                    ...
                    <p style={{marginTop:'90px'}}><strong>left-fix</strong></p>
