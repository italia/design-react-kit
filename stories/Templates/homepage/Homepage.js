...
import { Button, Card, CardBody, CardImg, CardTitle, CardText, CardCategory, CardSignature, CardReadMore, Container, Icon, Row, Col } from '../../../src'
                        ...
                        <div className="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-3">
                            ...
                            <Card teaser noWrapper className="no-after rounded shadow">
                                <CardBody className="pb-5">
                                    ...
                                    <div className="link-list-wrapper mt-4">
                        ...
                        <Col lg={{ size: 10, offset: 1 }} xl={{ size: 8, offset: 2 }}>
                            ...
                            <Row>
                                <Col className="text-center">
                                    <a href="#" className="btn btn-primary mt-5">Vedi tutti</a>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                            ...
                            <Col lg={3} md={3} sm={6} className="pb-2">
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Giunta e consiglio">Giunta e
                    consiglio</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Aree di competenza">Aree di
                    competenza</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Associazioni e società partecipate">Associazioni
                            ...
                            <Col lg={3} md={3} sm={6} className="pb-2">
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        ...
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Domande e iscrizioni">Domande e
                    iscrizioni</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Autorizzazioni e concessioni">Autorizzazioni
                    e concessioni</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Certificati e dichiarazioni">Certificati
                    e dichiarazioni</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <Col lg={3} md={3} sm={6} className="pb-2">
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        ...
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Comunicati stampa">Comunicati
                    stampa</a>
                                        </li>
                                    </ul>
                                </div>
