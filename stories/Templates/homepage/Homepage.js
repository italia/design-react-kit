...
import { Button, Card, CardBody, CardTitle, CardText, CardImg, CardCategory, CardReadMore, Container, Collapse, DropdownMenu, DropdownToggle, DropdownItem, Icon, Row, Col, LinkListItem, LinkList, Header, Headers, HeaderContent, HeaderSearch, HeaderRightZone, HeaderSocialsZone, HeaderToggler, Nav, NavItem, NavLink, HeaderBrand, UncontrolledDropdown } from '../../../src'
...
const Homepage = () => {
    ...
    return (<>
                        ...
                        <Row>
                            <Col lg={3} md={3} sm={6} className="pb-2">
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Giunta e consiglio">
                                                Giunta e consiglio
                                </a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Aree di competenza">
                                                Aree di competenza
                                </a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Dipendenti">Dipendenti</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Luoghi">Luoghi</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Associazioni e società partecipate">
                            ...
                            <Col lg={3} md={3} sm={6} className="pb-2">
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Pagamenti">Pagamenti</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Sostegno">Sostegno</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Domande e iscrizioni">
                                                Domande e iscrizioni
                                </a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Segnalazioni">Segnalazioni</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Autorizzazioni e concessioni">
                                                Autorizzazioni e concessioni
                                </a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Certificati e dichiarazioni">
                            ...
                            <Col lg={3} md={3} sm={6} className="pb-2">
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Notizie">Notizie</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Eventi">Eventi</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Comunicati stampa">
                                                Comunicati stampa
                                </a>
                                        </li>
                                    </ul>
                            ...
                            <Col lg={3} md={3} sm={6}>
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Progetti e attività">Progetti e
        attività</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Delibere, determine e ordinanze">Delibere,
        determine e ordinanze</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Bandi">Bandi</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Concorsi">Concorsi</a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Albo pretorio">Albo pretorio</a>
                                        </li>
                                    </ul>
                                </div>
                            </Col>
                        ...
                        <Row>
                            ...
                            <Col lg={3} md={3} className="pb-2">
                                ...
                                <div className="link-list-wrapper">
                                    <ul className="footer-list link-list clearfix">
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: Posta Elettronica Certificata">
                                                Posta Elettronica Certificata
                                </a>
                                        </li>
                                        <li>
                                            <a className="list-item" href="#" title="Vai alla pagina: URP - Ufficio Relazioni con il Pubblico">
                            ...
                            <Col lg={3} md={3} className="pb-2">
                                ...
                                <form action="#" className="form-newsletter" method="post">
                                    <label className="text-white font-weight-semibold active" htmlFor="input-newsletter" style={{ transition: "none 0s ease 0s" }}>Iscriviti per riceverla</label>
                                    <input className="form-control" id="input-newsletter" name="input-newsletter" placeholder="mail@example.com" type="email" />
                                ...
                                <ul className="list-inline text-left social">
                                    <li className="list-inline-item">
                                        <a className="p-2 text-white" href="#" target="_blank">
                                            ...
                                            <span className="sr-only">Designers Italia</span></a>
                                    </li>
                                    <li className="list-inline-item">
                                        <a className="p-2 text-white" href="#" target="_blank">
                                    ...
                                    <li className="list-inline-item">
                                        <a className="p-2 text-white" href="#" target="_blank">
                                            ...
                                            <span className="sr-only">Medium</span></a>
                                    </li>
                                    <li className="list-inline-item">
                                        <a className="p-2 text-white" href="#" target="_blank">
                                            <Icon icon='it-behance' color="white" size="sm" className="align-top" />
                                            <span className="sr-only">Behance</span></a>
                                    </li>
                                </ul>
                            </Col>
                        </Row>
        ...
        {notification && <div className="notification dismissable with-icon" role="alert" id="notification-esempi" aria-labelledby="notification-esempi-title" style={{ display: "block" }}>
