...
const CollapseNestedExample = () => {
  ...
  return (
    <Accordion>
      <AccordionHeader active={collapseOpen1} onToggle={() => setCollapseOpen1(!collapseOpen1)}>
        Collapse header #1
      </AccordionHeader>
      <AccordionBody active={collapseOpen1}>
        <Accordion>
          <AccordionHeader active={nestedCollapseOpen1} onToggle={() => setNestedCollapseOpen1(!nestedCollapseOpen1)}>
          ...
          <AccordionHeader active={nestedCollapseOpen2} onToggle={() => setNestedCollapseOpen2(!nestedCollapseOpen2)}>
          ...
          <AccordionHeader active={nestedCollapseOpen3} onToggle={() => setNestedCollapseOpen3(!nestedCollapseOpen3)}>
      ...
      <AccordionHeader active={collapseOpen2} onToggle={() => setCollapseOpen2(!collapseOpen2)}>
        Collapse header #2
      </AccordionHeader>
      ...
      <AccordionHeader active={collapseOpen3} onToggle={() => setCollapseOpen3(!collapseOpen3)}>
        Collapse header #3
      </AccordionHeader>
