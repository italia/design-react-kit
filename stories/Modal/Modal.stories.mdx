...
import { Modal, ModalHeader, Callout, CalloutTitle, CalloutText } from '../../src';
...
<div className='docs'>
  <Callout color='warning'>
    ...
    <CalloutText>
      <p>
        Per tutti i componenti Modale viene automaticamente aggiunto l'attributo <code>role="dialog"</code> all'elemento contenitore. (<a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/ARIA_Techniques/Using_the_dialog_role" target="_blank" rel="noreferrer">maggiori info su MDN</a>).
        </p>
      <p>L’attributo <code>labelledby="..."</code> deve essere assegnato al componente <code>Modal</code> ed usare come valore l'ID del componente <code>ModalHeader</code>.(<a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/ARIA_Techniques/Using_the_aria-labelledby_attribute" target="_blank" rel="noreferrer">maggiori info su MDN</a>)
      </p>
      <p>
        Approfondisci l’argomento sul sito delle <a href="https://www.w3.org/TR/wai-aria-practices/#dialog_modal"target="_blank" rel="noreferrer">WAI-ARIA Authoring Practices</a>.
      </p>
    </CalloutText>
  </Callout>
</div>
