...
<div className='docs'>
  <Callout color='warning'>
    ...
    <CalloutText>
      Per tutti i componenti Modale viene automaticamente aggiunto l'attributo{' '}
      <Code>role="dialog"</Code> e <Code>role="document"</Code> all'elemento contenitore. (
      <a
    ...
    <CalloutText>
      L’attributo <Code>labelledby="..."</Code> deve essere assegnato al
      componente <Code>Modal</Code> ed usare come valore l'ID del componente{' '}
