        ...
        <div className="row justify-content-md-center">
            <div className="col-md-10 my-4">
                ...
                <div className="col-4 mx-auto">
                    <svg id='Layer_2_1_' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 841.9 595.3'>
                        <g fill='#06C'>
                ...
                <p>React Kit è un <b>set di componenti open-source per React</b> conforme alle Linee guida di design per i servizi digitali della PA, costruito sulle basi dello <a
                        href="https://github.com/italia/design-ui-kit"
                        target="_blank" rel="noopener noreferrer">UI Kit <i
                        className="it-external-link"></i></a> e della libreria <a
                ...
                <p>È possibile contribuire al progetto con il proprio codice o attraverso la segnalazione di bug al <a
                        ...
                        className="it-external-link"></i></a> su Slack.</p>
