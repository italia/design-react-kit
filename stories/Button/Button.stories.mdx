...
Per ulteriori informazioni sui bottoni si rimanda alla sezione `buttons` [della documentazione Reactstrap](https://github.com/reactstrap/reactstrap), quindi di [Bootstrap](https://getbootstrap.com/docs/5.1/components/buttons/).
