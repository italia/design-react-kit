...
Fare riferimento [alla documentazione Reactstrap](https://github.com/reactstrap/reactstrap) per maggiori dettagli sui componenti `Popover` e `UncontrolledPopover`: https://deploy-preview-2356--reactstrap.netlify.app/components/popovers/
