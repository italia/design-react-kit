...
<div className='docs'>
  <Callout color='success'>
    ...
    <CalloutText>
      Per ragioni di accessibilità è importante indicare all’interno dell’Avatar
      il nome dell’utente associato allo stesso.
    </CalloutText>
    <CalloutText>
    ...
    <CalloutText>
      Un Avatar con testo conterrà uno <Code>&lt;span&gt;</Code> per soli screen
      reader con il nome dell’utente indicato per esteso:{' '}
  ...
  <Callout color='success'>
    ...
    <CalloutText>
      ...
      <p>
        Ad esempio:{' '}
        <Code>
          &lt;span class="visually-hidden"&gt;Presenza: (stato presenza)&lt;/span&gt;
        </Code>
        .
      </p>
    </CalloutText>
  ...
  <Callout color='success'>
    ...
    <CalloutText>
      ...
      <p>
        Ad esempio:{' '}
        <Code>
          &lt;span class="visually-hidden"&gt;Status: (stato utenza)&lt;/span&gt;
        </Code>
        .
      </p>
    </CalloutText>
