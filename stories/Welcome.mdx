  ...
  <Row className='justify-content-md-center'>
    <Col md={10} className='my-4'>
      ...
      <p>
        ...
        <a href='https://github.com/italia/design-ui-kit' target='_blank' rel='noopener noreferrer'>UI Kit<i className='it-external-link' /></a>
        e della libreria
        <a href='https://italia.github.io/bootstrap-italia/' target='_blank' rel='noopener noreferrer'>Bootstrap Italia<i className='it-external-link' /></a>
      ...
      <p>
        ...
        >sulla pagina GitHub del progetto.</a>
      </p>
      <p>
        Esiste anche un
        <a href='https://github.com/italia/design-react-kit-playground' target='_blank' rel='noopener noreferrer'>progetto Playground</a>
