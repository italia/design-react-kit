...
<Container>
  <Row className='justify-content-md-center'>
    <Col md={10} className='my-4'>
      ...
      <p>
        React Kit è un <b>set di componenti open-source per React</b> conforme alle Linee guida di design per i servizi
        digitali della PA, costruito sulle basi dello{' '}
