  ...
  <Callout color='success'>
    ...
    <CalloutText>
      ...
      <p>
        ...
        <code>&lt;span&gt;</code>) possano essere resi attivabili tramite
        l’attributo <code>tabindex="0"</code>, ciò aggiungerà interruzioni di
        tabulazioni potenzialmente dannose per gli utenti che usano la tastiera
        per navigare. Inoltre, la maggior parte delle tecnologie assistive in
        questa situazione non annuncia il tooltip come ci si potrebbe invece
        attendere.
      </p>
      <p>
        Infine, non fare affidamento esclusivamente sull’evento “mouse over”
        come innesco del tooltip, in quanto ciò renderà impossibile
