...
Fare riferimento [alla documentazione Reactstrap](https://github.com/reactstrap/reactstrap) per maggiori dettagli sui componenti `Tooltip` e `UncontrolledTooltip`: https://deploy-preview-2356--reactstrap.netlify.app/components/tooltips/
