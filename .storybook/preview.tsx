    ...
    storySort: (a: string[], b: string[]) => {
      ...
      if (!groupScore) {
        const pageASectionIndex =
          prioritySections.indexOf(aFullStoryName) + 1 || prioritySections.indexOf(aSubSections[0]) + 1;
        const pageBSectionIndex =
          prioritySections.indexOf(bFullStoryName) + 1 || prioritySections.indexOf(bSubSections[0]) + 1;
