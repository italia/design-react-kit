...
# Design React Kit
A React toolkit that implements [Bootstrap Italia](https://italia.github.io/bootstrap-italia/).

An easy-to-use showcase written with [Storybook](https://storybook.js.org/) to navigate the library and view components in action.
A public version of the Storybook is available [here](https://italia.github.io/design-react-kit).
