...
const GoBack = ({ className, link = false, up = false, children }) => {
  ...
  return /* @__PURE__ */ React.createElement(Tag, { className: classNames(className, "go-back"), color: "primary", onClick: goBack }, /* @__PURE__ */ React.createElement(
    Icon,
    {
...
GoBack.__docgenInfo = { "description": "", "methods": [], "displayName": "GoBack", "props": { "className": { "required": false, "tsType": { "name": "string" }, "description": "Optional classnames to pass to the element" }, "link": { "required": false, "tsType": { "name": "boolean" }, "description": "Render the link variant of the go back button", "defaultValue": { "value": "false", "computed": false } }, "up": { "required": false, "tsType": { "name": "boolean" }, "description": "Render the up variant of the go back button", "defaultValue": { "value": "false", "computed": false } }, "children": { "required": false, "tsType": { "name": "ReactChild" }, "description": "" } } };
const meta = {
  title: "Documentazione/Componenti/GoBack",
  component: GoBack
};
const Esempi = {
  render: () => /* @__PURE__ */ React.createElement(GoBack, {
    link: true
  }, "Torna indietro")
};
const Pulsanti = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(GoBack, null, "Torna indietro"), " ", /* @__PURE__ */ React.createElement(GoBack, {
    up: true
  }, "Livello superiore"))
};
const PulsantiSoloIcona = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(GoBack, null), " ", /* @__PURE__ */ React.createElement(GoBack, {
    up: true
  }))
};
Esempi.parameters = {
