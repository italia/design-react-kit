...
import { e as canUseDOM, c as targetPropType, T as TransitionTimeouts, k as keyCodes, f as focusableElements, g as getTarget, h as getOriginalBodyPadding, j as conditionallyUpdateScrollbar, m as mapToCssModules, s as setScrollbarWidth, o as omit, t as tagPropType } from "./utils-l7qJ8bIE.js";
import { I as Icon } from "./Icon-Dropx6Zw.js";
import { m as mapToCssModules$1 } from "./utils-DNvasP3d.js";
...
import { I as Input } from "./Input-rmw1t2PN.js";
...
const ModalHeader = ({
  ...
  return /* @__PURE__ */ React.createElement(WrapTag, { ...props, className: classes }, icon != null ? /* @__PURE__ */ React.createElement(Icon, { icon }) : null, /* @__PURE__ */ React.createElement(Tag, { className: mapToCssModules$1("modal-title", cssModule) }, children), close || CloseButton);
};
ModalHeader.__docgenInfo = { "description": "", "methods": [], "displayName": "ModalHeader", "props": { "cssModule": { "required": false, "tsType": { "name": "CSSModule" }, "description": "" }, "tag": { "required": false, "tsType": { "name": "ReactElementType", "raw": "React.ElementType" }, "description": "Componente che conterrà il nodo titolo. Valore di default: h5", "defaultValue": { "value": "'h5'", "computed": false } }, "wrapTag": { "required": false, "tsType": { "name": "ReactElementType", "raw": "React.ElementType" }, "description": "Componente che contenitore per l'header. Valore di default: div.", "defaultValue": { "value": "'div'", "computed": false } }, "toggle": { "required": false, "tsType": { "name": "ReactMouseEventHandler", "raw": "React.MouseEventHandler<any>", "elements": [{ "name": "any" }] }, "description": "Funzione da passare al tasto di chiusura nell'intestazione. Quando questa funzione non è presente il tasto di chiusura non viene mostrato. Valore di default: undefined" }, "icon": { "required": false, "tsType": { "name": "string" }, "description": "Indica il nome dell'icona da utilizzare nel titolo." }, "className": { "required": false, "tsType": { "name": "string" }, "description": "Classi da aggiungere al nodo contenitore." }, "closeAriaLabel": { "required": false, "tsType": { "name": "string" }, "description": "Utilizzato per personalizzare il messaggio peer screen reader per il bottone di chiusura del modale. Valore di default: 'Close'", "defaultValue": { "value": "'Close'", "computed": false } } }, "composes": ["HTMLAttributes"] };
const meta = {
