...
import { D as Dropdown, a as DropdownToggle } from "./DropdownToggle-D1um2tsY.js";
...
const ToolbarDividerItem = () => /* @__PURE__ */ React.createElement("li", { className: "toolbar-divider", role: "separator", "aria-orientation": "vertical" });
...
function ToolbarItemLabel({
  ...
  if (disabled) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "toolbar-label" }, label));
  }
  if (!label) {
    return null;
  }
...
const ToolbarItem = ({
  ...
  if (dropdown) {
    return /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(Dropdown, { ...dropdownProps, toggle: onClick, isOpen: isDropdownOpen }, /* @__PURE__ */ React.createElement(
      DropdownToggle,
      {
        disabled,
        caret: true,
