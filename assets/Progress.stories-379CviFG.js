...
const Esempio = () => /* @__PURE__ */ React.createElement(Progress, {
  value: "50"
});
const Etichette = () => /* @__PURE__ */ React.createElement(Progress, {
  value: "35",
  label: "progresso"
});
const ProgressoIndeterminato = () => /* @__PURE__ */ React.createElement(Progress, {
  indeterminate: true,
  label: "In elaborazione..."
});
const Colori = () => /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Progress, {
  value: "25",
  color: "success"
...
const BottoneConProgressBar = () => /* @__PURE__ */ React.createElement("div", {
  className: "container"
...
Etichette.__docgenInfo = {
  "description": "",
  "methods": [],
  "displayName": "Etichette"
};
ProgressoIndeterminato.__docgenInfo = {
  "description": "",
  "methods": [],
  "displayName": "ProgressoIndeterminato"
};
Colori.__docgenInfo = {
  "description": "",
  "methods": [],
...
BottoneConProgressBar.__docgenInfo = {
  "description": "",
  "methods": [],
  "displayName": "BottoneConProgressBar"
};
Esempio.parameters = {
  ...Esempio.parameters,
  docs: {
    ...
    source: {
      originalSource: '() => <Progress value="50" />',
...
Etichette.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: '() => <Progress value="35" label="progresso" />',
...
ProgressoIndeterminato.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: '() => <Progress indeterminate label="In elaborazione..." />',
