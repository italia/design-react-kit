...
import { C as Container } from "./Container-BayWV13h.js";
import { C as Card } from "./Card-C6ckfsHe.js";
import { c as classNames$1 } from "./index-BqHsiMZl.js";
...
function Slide(Splide22, Components2, options) {
  ...
  var endCallback;
  function mount() {
    EventInterface(Splide22).bind(list, "transitionend", function(e2) {
...
var Splide2 = class extends e.Component {
  constructor() {
    super(...arguments);
    this.splideRef = e.createRef();
    this.slides = [];
  }
  componentDidMount() {
  ...
  sync(splide) {
    var _a2;
    (_a2 = this.splide) == null ? void 0 : _a2.sync(splide);
  }
  go(control) {
    var _a2;
    (_a2 = this.splide) == null ? void 0 : _a2.go(control);
  }
  getSlides() {
    var _a2;
    if (this.splide) {
      const children2 = (_a2 = this.splide.Components.Elements) == null ? void 0 : _a2.list.children;
  ...
  render() {
    ...
    return /* @__PURE__ */ e.createElement(Root, {
      className: classNames("splide", className),
      ref: this.splideRef,
      ...this.omit(props, ["options", ...EVENTS.map((event) => event[1])])
    }, hasTrack ? /* @__PURE__ */ e.createElement(SplideTrack, null, children2) : children2);
  }
};
...
const Carousel = ({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...attributes,
      className: classNames$1("it-carousel-wrapper", className, ...EXTRA_CLASSES[type]),
      options: conf
    },
    children2
  );
};
Carousel.__docgenInfo = { "description": "", "methods": [], "displayName": "Carousel", "props": { "type": { "required": true, "tsType": { "name": "string" }, "description": "" }, "children": { "required": false, "tsType": { "name": "ReactReactNode", "raw": "React.ReactNode" }, "description": "" }, "className": { "defaultValue": { "value": "''", "computed": false }, "required": false } }, "composes": ["SplideProps"] };
const CarouselSlide = ({
  children: children2
}) => {
  return /* @__PURE__ */ e.createElement(SplideSlide, null, /* @__PURE__ */ e.createElement("div", { className: "it-single-slide-wrapper" }, children2));
};
CarouselSlide.__docgenInfo = { "description": "", "methods": [], "displayName": "CarouselSlide" };
const meta = {
  title: "Documentazione/Componenti/Carousel",
  component: Container
};
const carouselSlide = /* @__PURE__ */ e.createElement(CarouselSlide, null, /* @__PURE__ */ e.createElement(Card, { rounded: true, shadow: "sm" }, /* @__PURE__ */ e.createElement("h3", { className: "it-card-title " }, /* @__PURE__ */ e.createElement("a", { href: "#" }, "Titolo del contenuto")), /* @__PURE__ */ e.createElement("div", { className: "it-card-body" }, /* @__PURE__ */ e.createElement("p", { className: "it-card-text" }, "Questo è un testo breve che riassume il contenuto della pagina di destinazione in massimo tre o quattro righe, senza troncamento.")), /* @__PURE__ */ e.createElement("footer", { className: "it-card-related it-card-footer" }, /* @__PURE__ */ e.createElement("time", { className: "it-card-date", dateTime: "2025-04-22" }, "22 aprile 2025"))));
const carouselSlides = [];
for (let i = 0; i < 10; i++) {
  carouselSlides.push(carouselSlide);
}
const carouselSlideLandscapeImage = /* @__PURE__ */ e.createElement(CarouselSlide, null, /* @__PURE__ */ e.createElement("div", { className: "it-single-slide-wrapper p-2e" }, /* @__PURE__ */ e.createElement(Card, { image: true, inline: true, rounded: true, shadow: "sm" }, /* @__PURE__ */ e.createElement("div", { className: "it-card-inline-content" }, /* @__PURE__ */ e.createElement("h3", { className: "it-card-title " }, /* @__PURE__ */ e.createElement("a", { href: "#" }, "Titolo contenuto editoriale")), /* @__PURE__ */ e.createElement("div", { className: "it-card-body" }, /* @__PURE__ */ e.createElement("address", { className: "it-card-signature" }, "di Maria Verde"), /* @__PURE__ */ e.createElement("p", { className: "it-card-text" }, "Questo è un testo breve che riassume il contenuto della pagina di destinazione in massimo tre o quattro righe, senza troncamento.")), /* @__PURE__ */ e.createElement("footer", { className: "it-card-related it-card-footer" }, /* @__PURE__ */ e.createElement("div", { className: "it-card-taxonomy" }, /* @__PURE__ */ e.createElement("a", { href: "#", className: "it-card-category it-card-link link-secondary" }, /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, "Categoria correlata: "), "Categoria")), /* @__PURE__ */ e.createElement("time", { className: "it-card-date", dateTime: "2025-04-22" }, "22 aprile 2025"))), /* @__PURE__ */ e.createElement("div", { className: "it-card-image-wrapper" }, /* @__PURE__ */ e.createElement("div", { className: "ratio ratio-16x9" }, /* @__PURE__ */ e.createElement("figure", { className: "figure img-full" }, /* @__PURE__ */ e.createElement("img", { src: "https://placeholderimage.eu/api/city/800/600", alt: "Breve descrizione immagine se ha senso nel contesto, marcare altrimenti come decorativa lasciando l'alt applicato ma vuoto." })))))));
const carouselSlidesLandascapeImages = [];
for (let i = 0; i < 3; i++) {
  carouselSlidesLandascapeImages.push(carouselSlideLandscapeImage);
}
const carouselHighImage = /* @__PURE__ */ e.createElement(CarouselSlide, null, /* @__PURE__ */ e.createElement(Card, { image: true, fullHeight: true, rounded: true, shadow: "sm" }, /* @__PURE__ */ e.createElement("h3", { className: "it-card-title" }, /* @__PURE__ */ e.createElement("a", { href: "#" }, "Titolo del contenuto")), /* @__PURE__ */ e.createElement("div", { className: "it-card-image-wrapper" }, /* @__PURE__ */ e.createElement("div", { className: "ratio ratio-16x9" }, /* @__PURE__ */ e.createElement("figure", { className: "figure img-full" }, /* @__PURE__ */ e.createElement("img", { src: "https://placeholderimage.eu/api/city/800/600", alt: "Breve descrizione immagine se ha senso nel contesto, marcare altrimenti come decorativa lasciando l'alt applicato ma vuoto." })))), /* @__PURE__ */ e.createElement("div", { className: "it-card-body" }, /* @__PURE__ */ e.createElement("p", { className: "it-card-text" }, "Questo è un testo breve.")), /* @__PURE__ */ e.createElement("footer", { className: "it-card-related it-card-footer" }, /* @__PURE__ */ e.createElement("div", { className: "it-card-taxonomy" }, /* @__PURE__ */ e.createElement("a", { href: "#", className: "it-card-category it-card-link link-secondary" }, /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, "Categoria correlata: "), "Categoria")), /* @__PURE__ */ e.createElement("time", { className: "it-card-date", dateTime: "2025-04-22" }, "22 aprile 2025"))));
const carouselHighImages = [];
for (let i = 0; i < 10; i++) {
  carouselHighImages.push(carouselHighImage);
}
const Base = {
  render: () => /* @__PURE__ */ e.createElement(Carousel, { type: "landscape-three-cols-arrows" }, carouselSlides)
};
const EvidenceImage = {
  render: () => /* @__PURE__ */ e.createElement(Carousel, { type: "landscape" }, carouselSlidesLandascapeImages)
};
const HighImage = {
  render: () => /* @__PURE__ */ e.createElement(Carousel, { type: "landscape-three-cols" }, carouselHighImages)
};
Base.parameters = {
  ...Base.parameters,
  docs: {
    ...
    source: {
      originalSource: '{\n  render: () => <Carousel type="landscape-three-cols-arrows">\n      {carouselSlides}\n    </Carousel>\n}',
      ...(_c = (_b = Base.parameters) == null ? void 0 : _b.docs) == null ? void 0 : _c.source
    }
  }
};
EvidenceImage.parameters = {
  ...EvidenceImage.parameters,
  docs: {
    ...(_d = EvidenceImage.parameters) == null ? void 0 : _d.docs,
    source: {
      originalSource: '{\n  render: () => <Carousel type="landscape">\n      {carouselSlidesLandascapeImages}\n    </Carousel>\n}',
      ...(_f = (_e = EvidenceImage.parameters) == null ? void 0 : _e.docs) == null ? void 0 : _f.source
    }
  }
};
HighImage.parameters = {
  ...HighImage.parameters,
  docs: {
    ...(_g = HighImage.parameters) == null ? void 0 : _g.docs,
    source: {
      originalSource: '{\n  render: () => <Carousel type="landscape-three-cols">\n      {carouselHighImages}\n    </Carousel>\n}',
      ...(_i = (_h = HighImage.parameters) == null ? void 0 : _h.docs) == null ? void 0 : _i.source
    }
  }
};
const __namedExportsOrder = ["Base", "EvidenceImage", "HighImage"];
const CarouselStories = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Base,
  EvidenceImage,
  HighImage,
