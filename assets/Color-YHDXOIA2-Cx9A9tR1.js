import { d as debounce2, b as CB, c as getControlId, _ as _B, e as SI, f as MarkupIcon, h as __toESM, i as __commonJS } from "./index-BVpq9B0D.js";
import { r as reactExports, e } from "./index-CoR6MlO7.js";
import { v as vr } from "./index-C2Bg70Bz.js";
import "./iframe-DgllHHqV.js";
import "./jsx-runtime-CSOqN9Rs.js";
...
var Wrapper = vr.div({ position: "relative", maxWidth: 250, '&[aria-readonly="true"]': { opacity: 0.5 } }), PickerTooltip = vr(CB)({ position: "absolute", zIndex: 1, top: 4, left: 4, "[aria-readonly=true] &": { cursor: "not-allowed" } }), TooltipContent = vr.div({ width: 200, margin: 5, ".react-colorful__saturation": { borderRadius: "4px 4px 0 0" }, ".react-colorful__hue": { boxShadow: "inset 0 0 0 1px rgb(0 0 0 / 5%)" }, ".react-colorful__last-control": { borderRadius: "0 0 4px 4px" } }), Note = vr(_B)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })), Swatches = vr.div({ display: "grid", gridTemplateColumns: "repeat(9, 16px)", gap: 6, padding: 3, marginTop: 5, width: 200 }), SwatchColor = vr.div(({ theme, active }) => ({ width: 16, height: 16, boxShadow: active ? `${theme.appBorderColor} 0 0 0 1px inset, ${theme.textMutedColor}50 0 0 0 4px` : `${theme.appBorderColor} 0 0 0 1px inset`, borderRadius: theme.appBorderRadius })), swatchBackground = `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`, Swatch = ({ value, style, ...props }) => {
  ...
  return e.createElement(Wrapper, { "aria-readonly": readonly }, e.createElement(PickerTooltip, { startOpen, trigger: readonly ? [null] : void 0, closeOnOutsideClick: true, onVisibleChange: () => addPreset(color), tooltip: e.createElement(TooltipContent, null, e.createElement(Picker, { color: realValue === "transparent" ? "#000000" : realValue, onChange: updateValue, onFocus, onBlur }), presets.length > 0 && e.createElement(Swatches, null, presets.map((preset, index) => e.createElement(CB, { key: `${preset.value}-${index}`, hasChrome: false, tooltip: e.createElement(Note, { note: preset.keyword || preset.value }) }, e.createElement(Swatch, { value: preset[colorSpace], active: color && id(preset[colorSpace]) === id(color[colorSpace]), onClick: () => updateValue(preset.value) }))))) }, e.createElement(Swatch, { value: realValue, style: { margin: 4 } })), e.createElement(Input, { id: getControlId(name), value, onChange: (e2) => updateValue(e2.target.value), onFocus: (e2) => e2.target.select(), readOnly: readonly, placeholder: "Choose color..." }), value ? e.createElement(ToggleIcon, { onClick: cycleColorSpace }) : null);
