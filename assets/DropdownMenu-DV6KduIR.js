...
import { t as tagPropType, P as PropTypes, b as targetPropType, d as deprecated, m as mapToCssModules, g as getTarget } from "./utils-CruPskUV.js";
...
import { u as useHeaderContext, S as SLIM } from "./HeaderContext-Dzs8nqu1.js";
  ...
  _createClass(DropdownMenu2, [{
    ...
    value: function render() {
      ...
      if (persist || this.context.isOpen && !this.context.inNavbar) {
        ...
        if (container) {
          return /* @__PURE__ */ FT.createPortal(popper, getTarget(container));
        }
        return popper;
      }
