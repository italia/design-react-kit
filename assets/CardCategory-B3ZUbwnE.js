...
const CardCategory = ({ iconName, iconTitle, date, href, onClick, testId, children, textDescription, dateDescription, ...rest }) => {
  const classes = classNames({
    "category-top": date || " ",
    "categoryicon-top": iconName
  });
  const categoryLink = !iconName && /* @__PURE__ */ React.createElement(React.Fragment, null, textDescription && /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, textDescription), /* @__PURE__ */ React.createElement("a", { href, className: "category", onClick }, children));
  ...
  const categoryIcon = iconName && /* @__PURE__ */ React.createElement(Icon, { icon: iconName, title: iconTitle });
  return /* @__PURE__ */ React.createElement("div", { className: classes, ...rest, "data-testid": testId }, categoryLink, categoryIcon, categoryText && textDescription && /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, textDescription), categoryText, dateDescription && /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, dateDescription), categoryDate);
};
