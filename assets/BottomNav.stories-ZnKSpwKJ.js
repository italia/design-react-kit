...
const BottomNav = ({ tag = "nav", testId, ...attributes }) => {
  const Tag = tag;
  return /* @__PURE__ */ e.createElement(Tag, { className: "bottom-nav", "data-testid": testId }, /* @__PURE__ */ e.createElement("ul", { ...attributes }));
};
...
const BottomNavItem = ({
  ...
  const badgeWrapper = Boolean(badge) && /* @__PURE__ */ e.createElement("div", { className: "badge-wrapper" }, /* @__PURE__ */ e.createElement("span", { className: "bottom-nav-badge" }, badge));
  const alertWrapper = Boolean(alert) && /* @__PURE__ */ e.createElement("div", { className: "badge-wrapper" }, /* @__PURE__ */ e.createElement("span", { className: "bottom-nav-alert" }));
  return /* @__PURE__ */ e.createElement("li", { ...attributes, "data-testid": testId }, /* @__PURE__ */ e.createElement(Tag, { href: url || link || "#", className: activeClass, to, onClick: onLinkClick }, badgeWrapper, alertWrapper, /* @__PURE__ */ e.createElement(Icon, { icon: iconName }), /* @__PURE__ */ e.createElement("span", { className: "bottom-nav-label" }, label, srText ? /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, srText) : null)));
};
...
const Esempi = {
  render: () => /* @__PURE__ */ e.createElement(BottomNav, null, /* @__PURE__ */ e.createElement(BottomNavItem, { label: "messaggi" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "immagini", iconName: "it-camera" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "documenti", iconName: "it-file" }))
};
const Esempi4Links = {
  render: () => /* @__PURE__ */ e.createElement(BottomNav, null, /* @__PURE__ */ e.createElement(BottomNavItem, { label: "messaggi" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "immagini", iconName: "it-camera" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "documenti", iconName: "it-file" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "preferiti", iconName: "it-star-outline" }))
};
const EsempioBadge = {
  render: () => /* @__PURE__ */ e.createElement(BottomNav, null, /* @__PURE__ */ e.createElement(BottomNavItem, { label: "messaggi", badge: 1, srText: "- 1 da leggere" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "immagini", badge: 2, iconName: "it-camera", srText: "- 2 da vedere", active: true }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "documenti", badge: 88, iconName: "it-file", srText: "- 88 da esaminare" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "preferiti", iconName: "it-star-outline" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "preferenze", iconName: "it-settings" }))
};
const Alert = {
  render: () => /* @__PURE__ */ e.createElement(BottomNav, null, /* @__PURE__ */ e.createElement(BottomNavItem, { alert: true, label: "messaggi", srText: "- nuovo contenuto disponibile" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "immagini", iconName: "it-camera" }), /* @__PURE__ */ e.createElement(BottomNavItem, { alert: true, label: "documenti", iconName: "it-file", srText: "- nuovo contenuto disponibile" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "preferiti", iconName: "it-star-outline" }), /* @__PURE__ */ e.createElement(BottomNavItem, { label: "preferenze", iconName: "it-settings" }))
};
Esempi.parameters = {
  ...Esempi.parameters,
  docs: {
