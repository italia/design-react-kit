...
import { P as Popper } from "./Popper-Nje4Jlb9.js";
import { t as tagPropType, b as targetPropType, d as deprecated, m as mapToCssModules, g as getTarget } from "./utils-BFoSoHid.js";
...
const DropdownMenu = ({ className, testId, children, ...attributes }) => {
  ...
  return /* @__PURE__ */ React.createElement(DropdownMenu$1, { className: classes, "data-testid": testId, ...attributes }, children);
};
