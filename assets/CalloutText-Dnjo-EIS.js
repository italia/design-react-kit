...
const Callout = ({
  ...
  return /* @__PURE__ */ React.createElement(Tag, { className: classes, ...attributes, "data-testid": testId }, !highlight && !detailed ? /* @__PURE__ */ React.createElement("div", { className: "callout-inner" }, children) : children);
};
