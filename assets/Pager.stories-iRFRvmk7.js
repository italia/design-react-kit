...
import { D as Dropdown, a as DropdownToggle } from "./DropdownToggle-B1F_za4J.js";
import { D as DropdownMenu } from "./DropdownMenu-CFlEVLFw.js";
...
const Pager = ({
  ...
  const listChildren = e.Children.toArray(children).filter((child) => child.type.name === "PaginationItem");
  const extraChildren = e.Children.toArray(children).filter((child) => child.type.name !== "PaginationItem");
