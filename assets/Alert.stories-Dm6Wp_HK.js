...
import { A as Alert } from "./Alert-CaPU0S5A.js";
...
const _LinkEvidenziato = {
  render: ({
    ...args
  }) => /* @__PURE__ */ e.createElement(Alert, { ...args }, "Questo è un alert con un esempio di", /* @__PURE__ */ e.createElement("a", { href: "#", className: "alert-link" }, "link"), "evidenziato."),
  args: {
    color: "danger"
  }
};
