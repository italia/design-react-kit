...
const SelectClassicaHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(Select, {
    ...
    value: ""
  }, "Scegli un'opzione"), /* @__PURE__ */ React.createElement("option", {
    value: "Value 1"
  }, "Lorem ipsum dolor sit amet"), /* @__PURE__ */ React.createElement("option", {
    value: "Value 2"
  }, "Duis vestibulum eleifend libero"), /* @__PURE__ */ React.createElement("option", {
    value: "Value 3"
  }, "Phasellus pretium orci sed odio tempus"), /* @__PURE__ */ React.createElement("option", {
    value: "Value 4"
  }, "Vestibulum bibendum ex vel augue porttitor sodales"), /* @__PURE__ */ React.createElement("option", {
    value: "Value 5"
  }, "Praesent quis elementum turpis"));
};
const SelectClassica = {
  render: () => {
    return /* @__PURE__ */ React.createElement(SelectClassicaHooks, null);
  }
};
...
const SelectDisabilitata = {
  render: () => {
    return /* @__PURE__ */ React.createElement(SelectDisabilitataHooks, null);
  }
};
const SelectConGruppiHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(Select, {
    ...
    value: ""
  }, "Scegli un'opzione"), /* @__PURE__ */ React.createElement("optgroup", {
    label: "Gruppo 1"
  }, /* @__PURE__ */ React.createElement("option", {
    value: "Value 1"
  }, "Lorem ipsum dolor sit amet"), /* @__PURE__ */ React.createElement("option", {
    ...
    value: "Value 3"
  }, "Phasellus pretium orci sed odio tempus")), /* @__PURE__ */ React.createElement("optgroup", {
    label: "Gruppo 2"
  }, /* @__PURE__ */ React.createElement("option", {
    value: "Value 4"
  }, "Vestibulum bibendum ex vel augue porttitor sodales"), /* @__PURE__ */ React.createElement("option", {
...
const SelectConGruppi = {
  render: () => {
    return /* @__PURE__ */ React.createElement(SelectConGruppiHooks, null);
  }
};
