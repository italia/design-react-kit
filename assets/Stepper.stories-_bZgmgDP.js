...
const StepperHeaderElement = ({
  ...
  return /* @__PURE__ */ e.createElement(Tag, { ...attributes, className: wrapperClasses, "data-testid": testId }, iconToPrepend && /* @__PURE__ */ e.createElement(Icon, { icon: iconToPrepend }), stepperNumber && /* @__PURE__ */ e.createElement("span", { className: spanClass }, stepperNumber), children, iconToAppend && /* @__PURE__ */ e.createElement(Icon, { icon: iconToAppend, className: iconClass }));
};
