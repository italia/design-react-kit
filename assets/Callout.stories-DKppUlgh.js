...
import { r as reactExports, e } from "./iframe-DX9ezpjg.js";
import { C as Callout, a as CalloutText } from "./CalloutText-S_iXCX2t.js";
...
import { C as CalloutTitle } from "./CalloutTitle-DJ3_ntMf.js";
...
const CalloutMoreFooter = ({
  ...
  return /* @__PURE__ */ e.createElement(Tag, { ...attributes, className: classes }, /* @__PURE__ */ e.createElement("div", { className: "collapse-header", id: `${id}-heading` }, /* @__PURE__ */ e.createElement(
    Button,
    {
      color: "primary",
  ...
  ), fileUrl && /* @__PURE__ */ e.createElement(
    "a",
    {
    ...
    /* @__PURE__ */ e.createElement(Icon, { icon: "it-download" }),
    /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, "PDF"),
    "Download"
    ...
    /* @__PURE__ */ e.createElement("div", { className: "collapse-body" }, children)
  ));
};
...
const EsempioBasico = {
  render: () => /* @__PURE__ */ e.createElement(Callout, null, /* @__PURE__ */ e.createElement(CalloutTitle, null, /* @__PURE__ */ e.createElement("span", { className: "text" }, "Titolo Callout")), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius."))
};
const EsempioConIcona = {
  render: () => /* @__PURE__ */ e.createElement(Callout, null, /* @__PURE__ */ e.createElement(CalloutTitle, null, /* @__PURE__ */ e.createElement(Icon, { icon: "it-info-circle", padding: false, "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, "Confermato"), /* @__PURE__ */ e.createElement("span", { className: "text" }, "Titolo Callout")), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius."))
};
const EsempioAccessibilita = {
  render: () => /* @__PURE__ */ e.createElement(Callout, null, /* @__PURE__ */ e.createElement(CalloutTitle, null, /* @__PURE__ */ e.createElement(Icon, { icon: "it-check-circle", padding: false, "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, "Confermato"), /* @__PURE__ */ e.createElement("span", { className: "text" }, "Titolo Callout")), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius."))
};
const CalloutVariantiColore = {
  render: ({
    ...args
  }) => /* @__PURE__ */ e.createElement(Callout, { color: args.color }, /* @__PURE__ */ e.createElement(CalloutTitle, null, /* @__PURE__ */ e.createElement(Icon, { icon: `it-${args.icon}-circle`, padding: false, "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", { className: "text" }, args.title)), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius.")),
  parameters: {
    docs: {
      controls: {
...
const CalloutHighlights = {
  render: ({
    ...args
  }) => /* @__PURE__ */ e.createElement(Callout, { highlight: true, color: args.color }, /* @__PURE__ */ e.createElement(CalloutTitle, null, /* @__PURE__ */ e.createElement(Icon, { icon: `it-${args.icon}-circle`, padding: false, "aria-hidden": true }), args.title), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas at erat id sem interdum efficitur eu sed nunc. Mauris sit amet erat eget augue molestie malesuada ut sed ex. In sed dignissim elit."), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius. Maecenas ullamcorper ", /* @__PURE__ */ e.createElement("a", { href: "#" }, "tincidunt nulla quis laoreet."))),
  parameters: {
    docs: {
      controls: {
        exclude: ["title", "className", "tag", "title", "highlight", "detailed", "testId"]
...
const CalloutApprofondimento = {
  render: () => /* @__PURE__ */ e.createElement(Callout, { color: "note", detailed: true }, /* @__PURE__ */ e.createElement(CalloutTitle, null, /* @__PURE__ */ e.createElement(Icon, { icon: "it-zoom-in", padding: false, "aria-hidden": true }), /* @__PURE__ */ e.createElement("span", null, "Approfondimento")), /* @__PURE__ */ e.createElement(CalloutText, null, "Quisque suscipit interdum augue non volutpat. Cras tristique arcu tortor. Mauris eu magna nibh. Curabitur malesuada neque in lectus sagittis accumsan. In vitae justo eros. Maecenas pellentesque lacinia ipsum vitae rhoncus. Vestibulum pretium tempor turpis, nec gravida eros viverra in. Proin dictum nibh ut semper tristique."), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas at erat id ", /* @__PURE__ */ e.createElement("strong", null, "sem interdum efficitur eu sed nunc."), " Mauris sit amet erat eget augue molestie malesuada ut sed ex. In sed dignissim elit. Donec efficitur, sem eget vestibulum auctor, sem erat interdum magna, eu commodo odio mauris semper dolor."), /* @__PURE__ */ e.createElement(CalloutText, null, "Maecenas vulputate ante dictum ", /* @__PURE__ */ e.createElement("a", { href: "#" }, "vestibulum volutpat"), ". Lorem ipsum dolor sit amet,", " ", /* @__PURE__ */ e.createElement("strong", null, "consectetur adipiscing elit."), " Aenean non augue non purus vestibulum varius. Maecenas ullamcorper tincidunt nulla quis laoreet."), /* @__PURE__ */ e.createElement(CalloutMoreFooter, { id: "example", fileUrl: "#" }, /* @__PURE__ */ e.createElement("p", null, "Aenean tortor enim, suscipit eget commodo at, imperdiet quis diam. Vestibulum non accumsan felis, at ultrices lorem. Pellentesque ac diam a ipsum cursus interdum id nec odio. Vestibulum nec congue mauris. Aliquam et dui purus. Mauris in imperdiet risus, sed blandit tellus. Donec posuere accumsan lacinia. Mauris dignissim, sem vel volutpat rhoncus, neque mi ullamcorper ante, vitae volutpat ipsum quam id purus. Duis tincidunt sodales nisl eget ultricies. Sed condimentum mi eu ex venenatis, quis bibendum dui ultrices. Quisque ex eros, pellentesque vitae enim sed, pharetra tempus dolor. Donec eu nibh ac lacus luctus pellentesque. Duis interdum scelerisque magna nec malesuada."), /* @__PURE__ */ e.createElement("p", null, "Maecenas at erat id ", /* @__PURE__ */ e.createElement("strong", null, "sem interdum efficitur eu sed nunc."), " Mauris sit amet erat eget augue molestie malesuada ut sed ex. In sed dignissim elit. Donec efficitur, sem eget vestibulum auctor, sem erat interdum magna, eu commodo odio mauris semper dolor."), /* @__PURE__ */ e.createElement("p", null, "Maecenas vulputate ante dictum ", /* @__PURE__ */ e.createElement("a", { href: "#" }, "vestibulum volutpat"), ". Lorem ipsum dolor sit amet,", " ", /* @__PURE__ */ e.createElement("strong", null, "consectetur adipiscing elit."), " Aenean non augue non purus vestibulum varius. Maecenas ullamcorper tincidunt nulla quis laoreet.")))
};
