...
import { r as reactDomExports } from "./index-Hv2vTVdx.js";
...
const PositionContext = reactExports.createContext(void 0);
...
function NotificationElement({ closeToast, toastProps, title, body, options }) {
  ...
  const content = typeof body === "string" ? /* @__PURE__ */ React.createElement("p", null, body) : body;
  ...
  return /* @__PURE__ */ React.createElement("div", { className: wrapperClass, style: customStyle }, /* @__PURE__ */ React.createElement("h5", null, title, icon ? /* @__PURE__ */ React.createElement(Icon, { icon }) : null), content, (!autoClose || dismissable) && /* @__PURE__ */ React.createElement(Button, { className: "notification-close", onClick: closeToast }, /* @__PURE__ */ React.createElement(Icon, { icon: "it-close" }), /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "Chiudi notifica: ", title)));
}
const createNotification = (title, body, options, closeToast, toastProps) => /* @__PURE__ */ React.createElement(NotificationElement, { title, body, options, closeToast, toastProps });
...
function useToast(props) {
  ...
  reactExports.useEffect(function() {
    if (isFn(props.onOpen))
      props.onOpen(reactExports.isValidElement(props.children) && props.children.props);
    return function() {
      if (isFn(syncProps.onClose))
        syncProps.onClose(reactExports.isValidElement(syncProps.children) && syncProps.children.props);
    };
  }, []);
  reactExports.useEffect(function() {
...
var Toast = function Toast2(props) {
  ...
  function renderCloseButton(closeButton2) {
    ...
    if (reactExports.isValidElement(closeButton2))
      return reactExports.cloneElement(closeButton2, props2);
  }
...
const NotificationManager = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(PositionContext.Provider, { value: fix }, /* @__PURE__ */ React.createElement("div", { ref: containerRef, id: containerId, style }, getToastToRender((_, toastList) => {
...
function notify(title, bodyOrOptions, options) {
  let body = isReactChild(bodyOrOptions) ? bodyOrOptions : void 0;
...
const EsempioMinimo = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, {
      outline: true,
      onClick: () => notify("Titolo", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor…")
    }, "Mostra Notifica"), /* @__PURE__ */ React.createElement(NotificationManager, {
      containerId: "esempio-base"
    }));
  }
};
const EsempioMinimoComponente = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, {
      outline: true,
      onClick: () => notify("Titolo", /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Lorem ipsum"), " dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor…"))
    }, "Mostra Notifica con componente React"), /* @__PURE__ */ React.createElement(NotificationManager, {
...
const _Example = {
  render: () => /* @__PURE__ */ React.createElement("div", {
    ...
    className: "mb-4"
  }, /* @__PURE__ */ React.createElement("strong", null, "Notifica standard")), /* @__PURE__ */ React.createElement(NotificationDoc, {
    id: "notifica-base",
    ...
    className: "mb-4"
  }, /* @__PURE__ */ React.createElement("strong", null, "Notifica con icona")), /* @__PURE__ */ React.createElement(NotificationDoc, {
...
const States = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", {
      ...
      className: "col-12 col-md-6 mb-4 mb-md-0"
    }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Success")), /* @__PURE__ */ React.createElement(NotificationDoc, {
      state: "success",
      title: "Titolo Notifica",
      style: NotificationStyle,
      ...
      className: "col-12 col-md-6"
    }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Error")), /* @__PURE__ */ React.createElement(NotificationDoc, {
      state: "error",
      title: "Titolo Notifica",
      style: NotificationStyle,
    ...
    }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Info")), /* @__PURE__ */ React.createElement(NotificationDoc, {
      state: "info",
      title: "Titolo Notifica",
      style: NotificationStyle,
    ...
    }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Warning")), /* @__PURE__ */ React.createElement(NotificationDoc, {
      state: "warning",
      title: "Titolo Notifica",
      style: NotificationStyle,
...
const _RoundingOfCorners = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", {
      ...
      className: "col-12 col-md-6 mb-4 mb-md-0"
    }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Base (4 angoli arrotondati)")), /* @__PURE__ */ React.createElement(NotificationDoc, {
      title: "Titolo Notifica",
      state: "success",
      style: NotificationStyle,
      ...
      className: "col-12 col-md-6"
    }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "top-fix")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(NotificationDoc, {
      title: "Titolo Notifica",
      state: "success",
      fix: "top",
      ...
      className: "mt-4"
    }, /* @__PURE__ */ React.createElement("strong", null, "bottom-fix")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(NotificationDoc, {
      title: "Titolo Notifica",
      state: "success",
      fix: "bottom",
      ...
      className: "mt-4"
    }, /* @__PURE__ */ React.createElement("strong", null, "left-fix")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(NotificationDoc, {
      title: "Titolo Notifica",
      state: "success",
      fix: "left",
      ...
      className: "mt-4"
    }, /* @__PURE__ */ React.createElement("strong", null, "right-fix")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(NotificationDoc, {
      title: "Titolo Notifica",
      state: "success",
      fix: "right",
...
const DefaultLocation = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", {
      className: "container test-desktop"
    }, /* @__PURE__ */ React.createElement(NotificationDoc, {
      state: "success",
      title: "Titolo Notifica",
      id: "notifica"
    }, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor…"));
...
const FixedPositions = {
  render: () => {
    return /* @__PURE__ */ React.createElement("div", {
      className: "container test-desktop"
    }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(NotificationDoc, {
      title: "Top Fix",
      fix: "top",
      state: "success",
      id: "notifica-fixed-top"
    }, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor…")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(NotificationDoc, {
      title: "Left Fix",
      fix: "left",
      state: "success",
...
const NotificationOptionsComponent_Fake = () => {
  return null;
};
...
NotificationOptionsComponent_Fake.parameters = {
  ...NotificationOptionsComponent_Fake.parameters,
  docs: {
    ...(_B = NotificationOptionsComponent_Fake.parameters) == null ? void 0 : _B.docs,
    source: {
      originalSource: "() => {\n  return null;\n}",
      ...(_D = (_C = NotificationOptionsComponent_Fake.parameters) == null ? void 0 : _C.docs) == null ? void 0 : _D.source
    }
  }
};
const __namedExportsOrder = ["EsempioMinimo", "EsempioMinimoComponente", "_Example", "_NotificationWithMessageStatic", "Dismissable", "States", "_RoundingOfCorners", "DefaultLocation", "FixedPositions", "NotificationOptionsComponent_Fake"];
const NotificationStories = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  FixedPositions,
  NotificationOptionsComponent_Fake,
  States,
  _Example,
...
export {
  ...
  NotificationOptionsComponent_Fake as c,
  _NotificationWithMessageStatic as d,
  _RoundingOfCorners as e,
  DefaultLocation as f
};
