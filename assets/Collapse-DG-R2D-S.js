...
import { P as PropTypes, p as pick, a as TransitionPropTypeKeys, o as omit, m as mapToCssModules, t as tagPropType, T as TransitionTimeouts, e as TransitionStatuses } from "./utils-CuFJfndW.js";
import { T as Transition } from "./Transition-BXtxyP2_.js";
...
const Collapse = ({
  ...
  const [isExpanded, setIsExpanded] = reactExports.useState(isOpen);
  ...
  reactExports.useEffect(() => {
    ...
    const handleKeyDown = (e2) => {
      if (e2.key === "Escape" && isOpen) {
        onOverlayClick == null ? void 0 : onOverlayClick();
      }
    };
  ...
  if (megamenu || navbar) {
    ...
    return /* @__PURE__ */ e.createElement(
      Collapse$1,
      {
        ...
        "aria-label": isOpen ? "Menu di navigazione" : void 0,
        "data-testid": testId,
        ...attributes
      },
      /* @__PURE__ */ e.createElement("div", { className: overlayClasses, style: displayStyle, onClick: onOverlayClick }),
