...
import { B as Button$1 } from "./Button-MsrGxmE9.js";
const Button = ({
  tag = "button",
  icon = false,
  color = "",
  ...
  return /* @__PURE__ */ React.createElement(Button$1, { className: classes, "data-testid": testId, ...baseProps, ...attributes, ...ariaAttributes });
};
