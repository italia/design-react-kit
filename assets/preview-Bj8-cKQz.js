...
var decorators = (FEATURES == null ? void 0 : FEATURES.backgroundsStoryGlobals) ? [withBackgroundAndGrid] : [withGrid, withBackground], parameters = { [PARAM_KEY]: { grid: { cellSize: 20, opacity: 0.5, cellAmount: 5 }, disable: false, ...!(FEATURES == null ? void 0 : FEATURES.backgroundsStoryGlobals) && { values: Object.values(DEFAULT_BACKGROUNDS) } } }, modern = { [PARAM_KEY]: { value: void 0, grid: false } }, initialGlobals = (FEATURES == null ? void 0 : FEATURES.backgroundsStoryGlobals) ? modern : { [PARAM_KEY]: null };
export {
  decorators,
  initialGlobals,
  parameters
