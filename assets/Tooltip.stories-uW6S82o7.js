...
const _EsempiInterattiviWithHooks = (x) => {
...
const _EsempiInterattivi = {
  render: (placement, text) => /* @__PURE__ */ React.createElement(_EsempiInterattiviWithHooks, {
    ...placement,
    ...text
  }),
  parameters: {
...
_EsempiInterattivi.parameters = {
  ..._EsempiInterattivi.parameters,
  docs: {
    ...(_j = _EsempiInterattivi.parameters) == null ? void 0 : _j.docs,
    source: {
      originalSource: `{
  ...
  argTypes: {
    placement: {
      ...
      ...(_l = (_k = _EsempiInterattivi.parameters) == null ? void 0 : _k.docs) == null ? void 0 : _l.source
    }
  }
};
const __namedExportsOrder = ["Esempi", "EsempiConControllo", "Posizioni", "_EsempiInterattivi"];
...
export {
  ...
  Posizioni as P,
  TooltipStories as T,
  _EsempiInterattivi as _,
  EsempiConControllo as a
};
