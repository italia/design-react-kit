...
const InputNumericoDimensionamento = {
  render: () => {
    return /* @__PURE__ */ React.createElement(InputNumericoDimensionamentoHooks, null);
  },
  parameters: {
    docs: {
      canvas: {
...
const InputNumericoSteps = {
  render: () => {
    return /* @__PURE__ */ React.createElement(InputNumericoStepsHooks, null);
  },
  parameters: {
    docs: {
      canvas: {
...
const InputNumericoValuta = {
  render: () => {
    return /* @__PURE__ */ React.createElement(InputNumericoValutaHooks, null);
  },
  parameters: {
    docs: {
      canvas: {
...
const InputNumericoPercentuale = {
  render: () => {
    return /* @__PURE__ */ React.createElement(InputNumericoPercentualeHooks, null);
  },
  parameters: {
    docs: {
      canvas: {
...
const InputNumericoRidimensionamento = {
  render: () => {
    return /* @__PURE__ */ React.createElement(InputNumericoRidimensionamentoHooks, null);
  },
  parameters: {
    docs: {
      canvas: {
