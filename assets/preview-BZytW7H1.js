const __vite__fileDeps=["./axe-99MjEUst.js","./_commonjsHelpers-CcAunmGO.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
var { document } = global, channel = addons.getChannel(), active = false, activeStoryId, defaultParameters = { config: {}, options: {} }, handleRequest = async (storyId, input = defaultParameters) => {
  ...
  try {
    if (!active) {
      ...
      let { default: axe } = await __vitePreload(() => import("./axe-99MjEUst.js").then((n) => n.a), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url), { element = "#storybook-root", config, options = {} } = input, htmlElement = document.querySelector(element);
