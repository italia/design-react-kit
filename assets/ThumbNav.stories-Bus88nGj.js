...
const ThumbNavItem = ({
  ...
  return /* @__PURE__ */ React.createElement("li", { ...attributes, "data-testid": testId }, /* @__PURE__ */ React.createElement("a", { href: targetUrl, className: classes }, /* @__PURE__ */ React.createElement("img", { src: imageUrl, alt: actionDescription })));
};
