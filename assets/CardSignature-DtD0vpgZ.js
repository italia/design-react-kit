...
const CardReadMore = ({
  ...
  return /* @__PURE__ */ e.createElement(Tag, { className: classes, href, ...attributes, "data-testid": testId }, /* @__PURE__ */ e.createElement("span", { className: "text" }, text), iconName && /* @__PURE__ */ e.createElement(Icon, { icon: iconName }));
};
