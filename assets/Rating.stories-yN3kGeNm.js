...
const RatingBase = {
  render: ({
    ...
    return /* @__PURE__ */ e.createElement(Rating, { value: rating, legend, inputs: ["star1a", "star2a", "star3a", "star4a", "star5a"], name: "ratingA", onChangeRating: setRating });
  },
  args: {
    value: 0,
    legend: "Rating"
...
RatingBase.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "{\n  render: ({\n    legend\n  }) => {\n    const [rating, setRating] = useState(0);\n    return <Rating value={rating} legend={legend} inputs={['star1a', 'star2a', 'star3a', 'star4a', 'star5a']} name='ratingA' onChangeRating={setRating} />;\n  },\n  args: {\n    value: 0,\n    legend: 'Rating'\n  },\n  argTypes: {\n    value: {\n      control: {\n        type: 'range',\n        min: 0,\n        max: 5,\n        step: 1\n      }\n    },\n    legend: {\n      control: {\n        type: 'text'\n      }\n    }\n  }\n}",
