...
const Toggle = ({ label, testId, ...rest }) => {
  return /* @__PURE__ */ React.createElement("div", { className: "toggles", "data-testid": testId }, /* @__PURE__ */ React.createElement(Label, { check: true }, label, /* @__PURE__ */ React.createElement(Input, { ...rest, type: "checkbox" }), /* @__PURE__ */ React.createElement("span", { className: "lever" })));
};
