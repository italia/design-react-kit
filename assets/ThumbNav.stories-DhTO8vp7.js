...
const ThumbNav = ({
  ...
  return /* @__PURE__ */ React.createElement("ul", { className: classes, ...attributes, "data-testid": testId });
};
...
const ThumbNavItem = ({
  ...
  return /* @__PURE__ */ React.createElement("li", { ...attributes, "data-testid": testId }, /* @__PURE__ */ React.createElement("img", { src: "https://picsum.photos/240/160?image=1056", className: "thumb-nav-resizer", "aria-hidden": "true", alt: "" }), /* @__PURE__ */ React.createElement("a", { href: targetUrl, className: classes }, /* @__PURE__ */ React.createElement("img", { src: imageUrl, alt: actionDescription })));
};
...
const Esempio = {
  render: () => /* @__PURE__ */ React.createElement(ThumbNav, null, /* @__PURE__ */ React.createElement(ThumbNavItem, {
    targetUrl: "#",
    imageUrl: "https://picsum.photos/480/320?image=1044",
    actionDescription: "Visualizza immagine 1"
  }), /* @__PURE__ */ React.createElement(ThumbNavItem, {
    targetUrl: "#",
...
const EsempioSmall = {
  render: () => /* @__PURE__ */ React.createElement(ThumbNav, {
    isSmall: true
  }, /* @__PURE__ */ React.createElement(ThumbNavItem, {
    targetUrl: "#",
    imageUrl: "https://picsum.photos/480/320?image=1044",
...
}), /* @__PURE__ */ React.createElement(ThumbNav, {
  isSmall: true,
  position
}, /* @__PURE__ */ React.createElement(ThumbNavItem, {
  targetUrl: "#",
...
EsempioAutoWidth.__docgenInfo = {
  "description": "",
  "methods": [],
  "displayName": "EsempioAutoWidth",
  "props": {
    "fixedWidth": {
      "required": false,
      "tsType": {
