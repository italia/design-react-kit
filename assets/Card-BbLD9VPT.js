...
const Card = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: wrapperClasses, "data-testid": testId }, /* @__PURE__ */ React.createElement(Card$1, { ...attributes, className: cardClasses, tag, href: tag === "a" ? href : void 0 }));
};
