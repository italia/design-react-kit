const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./test-utils-CReGSLdl.js","./_commonjsHelpers-CcAunmGO.js","./index-CoR6MlO7.js","./index-CnhJHytA.js","./react-18-DmjiV1lP.js","./client-B0m31bvj.js"])))=>i.map(i=>d[i]);
...
import { r as reactExports, e, R as React3 } from "./index-CoR6MlO7.js";
...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") ;
    ...
    let deprecatedTestUtils = await __vitePreload(() => import("./test-utils-CReGSLdl.js").then((n) => n.t), true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url);
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await __vitePreload(async () => {
    const { renderElement: renderElement2, unmountElement: unmountElement2 } = await import("./react-18-DmjiV1lP.js");
    return { renderElement: renderElement2, unmountElement: unmountElement2 };
  }, true ? __vite__mapDeps([4,2,1,5,3]) : void 0, import.meta.url), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? e.createElement(Story, { ...storyContext }) : e.createElement(ErrorBoundary, { showMain, showException }, e.createElement(Story, { ...storyContext })), element = Wrapper ? e.createElement(Wrapper, null, content) : content;
...
var parameters = { renderer: "react" }, decorators = [(story, context) => {
  ...
  try {
    let { configure } = await __vitePreload(async () => {
      const { configure: configure2 } = await import("./index-C_vOVts8.js").then((n) => n.a);
