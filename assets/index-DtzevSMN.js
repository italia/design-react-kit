import { r as reactExports, g as getDefaultExportFromCjs } from "./iframe-WcRkBu1E.js";
...
function oj(a, b, c) {
  ...
  if (f) {
    ...
    0 === (g & 1) && b.child !== e ? (d = b.child, d.childLanes = 0, d.pendingProps = k, b.deletions = null) : (d = Pg$1(e, k), d.subtreeFlags = e.subtreeFlags & 14680064);
    null !== h ? f = Pg$1(h, f) : (f = Tg(f, g, c, null), f.flags |= 2);
    f.return = b;
    d.return = b;
    d.sibling = f;
    b.child = d;
  ...
  f = a.child;
  a = f.sibling;
  d = Pg$1(f, { mode: "visible", children: d.children });
...
function Zi(a, b, c) {
  ...
  if (null !== b.child) {
    a = b.child;
    c = Pg$1(a, a.pendingProps);
    b.child = c;
    for (c.return = b; null !== a.sibling; ) a = a.sibling, c = c.sibling = Pg$1(a, a.pendingProps), c.return = b;
    c.sibling = null;
  }
  return b.child;
}
...
const Pg = /* @__PURE__ */ getDefaultExportFromCjs(reactDomExports);
export {
  Pg as P,
