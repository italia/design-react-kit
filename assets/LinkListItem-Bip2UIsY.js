...
const LinkList = ({
  ...
  if (sublist) {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, header, /* @__PURE__ */ React.createElement("ul", { ...attributes, className: classes }));
  }
  return /* @__PURE__ */ React.createElement(Tag, { className: wrapperClasses, "data-testid": testId }, header, /* @__PURE__ */ React.createElement("ul", { ...attributes, className: classes }));
};
...
const LinkListItem = ({
  ...
  if (header && href) {
    return /* @__PURE__ */ React.createElement("li", { className: wrapperClassName, "data-testid": testId }, /* @__PURE__ */ React.createElement(Tag, null, /* @__PURE__ */ React.createElement("a", { href: href || "#", ...attributes, className: classes, ...handlers }, children)));
  }
...
const LinkListTitleIconWrapper = ({ children }) => {
  return /* @__PURE__ */ React.createElement("span", { className: "list-item-title-icon-wrapper" }, children);
};
