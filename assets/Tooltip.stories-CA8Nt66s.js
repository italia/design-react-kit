...
import { T as Tooltip, U as UncontrolledTooltip } from "./UncontrolledTooltip-CukTvrvd.js";
...
const EsempiInterattivi = {
  render: (placement, text) => /* @__PURE__ */ e.createElement(EsempiInterattiviWithHooks, { ...placement, ...text }),
  parameters: {
    layout: "centered"
  },
  args: {
