...
const InputContainer = ({
  ...
  if (hasButtonRight || hasIconLeft) {
    return /* @__PURE__ */ React.createElement("div", { className: wrapperClass, "data-testid": testId }, /* @__PURE__ */ React.createElement("div", { className: "input-group" }, hasIconLeft && /* @__PURE__ */ React.createElement("span", { className: "input-group-text" }, iconLeft), /* @__PURE__ */ React.createElement("label", { htmlFor: id, className: activeClass + " " + extraLabelClass }, label), children, infoText && /* @__PURE__ */ React.createElement("small", { id: infoId, className: "form-text" }, infoText), /* @__PURE__ */ React.createElement("div", { className: validationTextClass }, validationText), hasButtonRight && /* @__PURE__ */ React.createElement("div", { className: "input-group-append" }, buttonRight)));
  }
