...
const Input = ({
  ...
  if (["currency", "percentage", "adaptive", "number"].includes(type)) {
    return /* @__PURE__ */ e.createElement(InputContainer, { ...containerProps }, /* @__PURE__ */ e.createElement(
      ...
      /* @__PURE__ */ e.createElement("span", { className: "input-group-text align-buttons flex-column" }, /* @__PURE__ */ e.createElement("button", { className: "input-number-add", onClick: () => clickIncrDecr(1), type: "button" }, /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, incrementLabel || "")), /* @__PURE__ */ e.createElement("button", { className: "input-number-sub", onClick: () => clickIncrDecr(-1), type: "button" }, /* @__PURE__ */ e.createElement("span", { className: "visually-hidden" }, decrementLabel || "")))
    ));
  }
  if (placeholder) {
    return /* @__PURE__ */ e.createElement(InputContainer, { ...containerProps }, /* @__PURE__ */ e.createElement(
