import { _ as __toESM, a as __commonJS, b as __esm, c as __toCommonJS, d as __export } from "./chunk-XP5HYGXS-CQBei2qV.js";
import { c as cn, n as nn, y as yn, g as gt, z, o as on, j as je, l, B, a as oe, Y } from "./index-9xAnpW0o.js";
...
`), cooked: this.value }, this.next(), elem.tail = this.type === types.backQuote, this.finishNode(elem, "TemplateElement");
  ...
  pp$9.readInt = function(radix, len, maybeLegacyOctalNumericLiteral) {
    for (var allowSeparators = this.options.ecmaVersion >= 12 && len === void 0, isLegacyOctalNumericLiteral = maybeLegacyOctalNumericLiteral && this.input.charCodeAt(this.pos) === 48, start = this.pos, total = 0, lastCode = 0, i = 0, e2 = len ?? 1 / 0; i < e2; ++i, ++this.pos) {
...
var require_react_is_production_min2 = __commonJS({ "../../node_modules/react-element-to-jsx-string/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
  ...
  exports.isValidElementType = function(a) {
    return typeof a == "string" || typeof a == "function" || a === d || a === f || a === e2 || a === m || a === n || a === t || typeof a == "object" && a !== null && (a.$$typeof === q || a.$$typeof === p || a.$$typeof === g || a.$$typeof === h || a.$$typeof === l2 || a.$$typeof === u || a.getModuleId !== void 0);
  };
  exports.typeOf = v;
} });
...
var createStringTreeNode = function(value) {
  ...
  if (!e.isValidElement(element)) throw new Error("react-element-to-jsx-string: Expected a React.Element, got `".concat(_typeof(element), "`"));
  ...
  var defaultProps = filterProps(element.type.defaultProps || {}, noChildren), childrens = e.Children.toArray(element.props.children).filter(onlyMeaningfulChildren).map(function(child) {
...
var renderJsx = (code, options) => {
  ...
  for (let i = 0; i < (options == null ? void 0 : options.skip); i += 1) {
    ...
    if (e.Children.count(renderedJSX) > 1) return logger.warn("Trying to skip an array of elements"), null;
    typeof renderedJSX.props.children > "u" ? (logger.warn("Not enough children to skip elements."), typeof renderedJSX.type == "function" && renderedJSX.type.name === "" && (renderedJSX = e.createElement(Type, { ...renderedJSX.props }))) : typeof renderedJSX.props.children == "function" ? renderedJSX = renderedJSX.props.children() : renderedJSX = renderedJSX.props.children;
  }
