...
const Alert = ({ testId, ...props }) => {
  return /* @__PURE__ */ React.createElement(Alert$1, { "data-testid": testId, ...props });
};
Alert.defaultProps = defaultProps;
Alert.__docgenInfo = { "description": "", "methods": [], "displayName": "Alert", "props": { "closeClassName": { "required": false, "tsType": { "name": "string" }, "description": "" }, "closeAriaLabel": { "required": false, "tsType": { "name": "string" }, "description": "" }, "cssModule": { "required": false, "tsType": { "name": "CSSModule" }, "description": "Oggetto contenente la nuova mappatura per le classi CSS." }, "color": { "required": false, "tsType": { "name": "union", "raw": "'primary' | 'secondary' | 'success' | 'danger' | 'warning' | string", "elements": [{ "name": "literal", "value": "'primary'" }, { "name": "literal", "value": "'secondary'" }, { "name": "literal", "value": "'success'" }, { "name": "literal", "value": "'danger'" }, { "name": "literal", "value": "'warning'" }, { "name": "string" }] }, "description": "Le varianti di colore definite in Bootstrap Italia", "defaultValue": { "value": "'success'", "computed": false } }, "fade": { "required": false, "tsType": { "name": "boolean" }, "description": "Quando abilitato mostra un'animazione di entrata ed uscita del componente Alert. Valore di default: true.", "defaultValue": { "value": "true", "computed": false } }, "tag": { "required": false, "tsType": { "name": "ElementType" }, "description": "Utilizzarlo in caso di utilizzo di componenti personalizzati" }, "transition": { "required": false, "tsType": { "name": "FadeProps" }, "description": "" }, "innerRef": { "required": false, "tsType": { "name": "Ref", "elements": [{ "name": "HTMLElement" }], "raw": "Ref<HTMLElement>" }, "description": "Da utilizzare per impostare un riferimento all'elemento DOM" }, "isOpen": { "required": false, "tsType": { "name": "boolean" }, "description": "", "defaultValue": { "value": "true", "computed": false } }, "toggle": { "required": false, "tsType": { "name": "MouseEventHandler", "elements": [{ "name": "any" }], "raw": "MouseEventHandler<any>" }, "description": "" }, "testId": { "required": false, "tsType": { "name": "string" }, "description": "" } }, "composes": ["HTMLAttributes"] };
export {
  Alert as A
};
