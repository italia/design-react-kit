...
import { t as tagPropType, w as warnOnce, m as mapToCssModules } from "./utils-BFoSoHid.js";
...
const Toggle = ({ label, testId, ...rest }) => {
  return /* @__PURE__ */ React.createElement("div", { className: "toggles", "data-testid": testId }, /* @__PURE__ */ React.createElement(Label, { check: true, for: rest.id }, label, /* @__PURE__ */ React.createElement(Input, { ...rest, type: "checkbox", "aria-describedby": rest.id ? rest.id + "Description" : "" }), /* @__PURE__ */ React.createElement("span", { className: "lever" })));
};
