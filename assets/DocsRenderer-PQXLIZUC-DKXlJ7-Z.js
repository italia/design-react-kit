const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-BKc5zArI.js","./iframe-DGcxMoyJ.js","./preload-helper-CQrtv1eE.js","./iframe-D3ZGZbVH.css"])))=>i.map(i=>d[i]);
...
import { H as HeadersMdx, f as AnchorMdx, h as CodeOrSourceMdx, D as Docs } from "./blocks-ipDcqZCV.js";
  ...
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-BKc5zArI.js");
          return { MDXProvider };
