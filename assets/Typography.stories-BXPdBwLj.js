...
const Abbrevazioni = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("abbr", {
    title: "attribute"
  }, "attr")), /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("abbr", {
    title: "HyperText Markup Language",
    className: "initialism"
  }, "HTML")))
};
const AllineamentoADestra = {
  render: () => /* @__PURE__ */ React.createElement("blockquote", {
...
const Dimensioni = {
  render: () => /* @__PURE__ */ React.createElement("table", null, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Intestazione"), /* @__PURE__ */ React.createElement("th", null, "Mobile"), /* @__PURE__ */ React.createElement("th", null, "Schermo > 576px"))), /* @__PURE__ */ React.createElement("tbody", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("h1", null, "h1")), /* @__PURE__ */ React.createElement("td", null, "Bold, 40px/48px"), /* @__PURE__ */ React.createElement("td", null, "Bold, 48px/60px")), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("h2", null, "h2")), /* @__PURE__ */ React.createElement("td", null, "Bold, 32px/40px"), /* @__PURE__ */ React.createElement("td", null, "Bold, 40px/48px")), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("h3", null, "h3")), /* @__PURE__ */ React.createElement("td", null, "Bold, 28px/32px"), /* @__PURE__ */ React.createElement("td", null, "Bold, 32px/40px")), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("h4", null, "h4")), /* @__PURE__ */ React.createElement("td", null, "SemiBold, 24px/28px"), /* @__PURE__ */ React.createElement("td", null, "SemiBold, 28px/40px")), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("h5", null, "h5")), /* @__PURE__ */ React.createElement("td", null, "Regular, 20px/24px"), /* @__PURE__ */ React.createElement("td", null, "Regular, 24px/40px")), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("h6", null, "h6")), /* @__PURE__ */ React.createElement("td", null, "SemiBold, 16px/24px"), /* @__PURE__ */ React.createElement("td", null, "SemiBold, 18px/28px"))))
};
const Intestazioni = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h1", null, "Intestazione di tipo h1"), /* @__PURE__ */ React.createElement("h2", null, "Intestazione di tipo h2"), /* @__PURE__ */ React.createElement("h3", null, "Intestazione di tipo h3"), /* @__PURE__ */ React.createElement("h4", null, "Intestazione di tipo h4"), /* @__PURE__ */ React.createElement("h5", null, "Intestazione di tipo h5"), /* @__PURE__ */ React.createElement("h6", null, "Intestazione di tipo h6"))
};
...
const IntestazioneSecondario = {
  render: () => /* @__PURE__ */ React.createElement("h4", null, "Intestazione ", /* @__PURE__ */ React.createElement("small", {
    className: "text-muted"
  }, "con testo secondario"))
};
const Link = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, "Esempio di ", /* @__PURE__ */ React.createElement("a", {
    href: "#"
  }, "link normale"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di ", /* @__PURE__ */ React.createElement("a", {
    href: "#",
...
const Liste = {
  ...
  }, /* @__PURE__ */ React.createElement("li", null, "Lorem ipsum dolor sit amet"), /* @__PURE__ */ React.createElement("li", null, "Consectetur adipiscing elit"), /* @__PURE__ */ React.createElement("li", null, "Integer molestie lorem at massa"), /* @__PURE__ */ React.createElement("li", null, "Facilisis in pretium nisl aliquet"), /* @__PURE__ */ React.createElement("li", null, "Nulla volutpat aliquam velit", /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, "Phasellus iaculis neque"), /* @__PURE__ */ React.createElement("li", null, "Purus sodales ultricies"), /* @__PURE__ */ React.createElement("li", null, "Vestibulum laoreet porttitor sem"), /* @__PURE__ */ React.createElement("li", null, "Ac tristique libero volutpat at"))), /* @__PURE__ */ React.createElement("li", null, "Faucibus porta lacus fringilla vel"), /* @__PURE__ */ React.createElement("li", null, "Aenean sit amet erat nunc"), /* @__PURE__ */ React.createElement("li", null, "Eget porttitor lorem"))
};
const ListeAllineate = {
  render: () => /* @__PURE__ */ React.createElement("dl", {
    className: "row"
  }, /* @__PURE__ */ React.createElement("dt", {
    className: "col-sm-3"
  }, "Description lists"), /* @__PURE__ */ React.createElement("dd", {
    className: "col-sm-9"
  }, "A description list is perfect for defining terms."), /* @__PURE__ */ React.createElement("dt", {
    className: "col-sm-3"
  }, "Euismod"), /* @__PURE__ */ React.createElement("dd", {
    className: "col-sm-9"
  }, /* @__PURE__ */ React.createElement("p", null, "Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit."), /* @__PURE__ */ React.createElement("p", null, "Donec id elit non mi porta gravida at eget metus.")), /* @__PURE__ */ React.createElement("dt", {
    className: "col-sm-3"
  }, "Malesuada porta"), /* @__PURE__ */ React.createElement("dd", {
    className: "col-sm-9"
  }, "Etiam porta sem malesuada magna mollis euismod."), /* @__PURE__ */ React.createElement("dt", {
    className: "col-sm-3 text-truncate"
  }, "Truncated term is truncated"), /* @__PURE__ */ React.createElement("dd", {
    className: "col-sm-9"
  }, "Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus."), /* @__PURE__ */ React.createElement("dt", {
    className: "col-sm-3"
  }, "Nesting"), /* @__PURE__ */ React.createElement("dd", {
    className: "col-sm-9"
  }, /* @__PURE__ */ React.createElement("dl", {
    className: "row"
  }, /* @__PURE__ */ React.createElement("dt", {
    className: "col-sm-4"
  }, "Nested definition list"), /* @__PURE__ */ React.createElement("dd", {
    className: "col-sm-8"
...
const ListeInline = {
  ...
  }, "Lorem ipsum"), /* @__PURE__ */ React.createElement("li", {
    className: "list-inline-item"
  }, "Phasellus iaculis"), /* @__PURE__ */ React.createElement("li", {
    className: "list-inline-item"
  }, "Nulla volutpat"))
};
const Lora = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", {
    className: "text-serif"
  }, "ABCDEFGHIJKLMNOPQRSTUVWXYZ"), /* @__PURE__ */ React.createElement("p", {
    className: "text-serif"
  }, "abcdefghijklmnopqrstuvwxyz"), /* @__PURE__ */ React.createElement("p", {
    className: "text-serif"
  }, "0123456789"))
...
const ParagrafiPersonalizzati = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("u", null, "sottolineato"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("mark", null, "evidenziato"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("em", null, "corsivo"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("strong", null, "in grassetto"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("small", null, "rimpicciolito"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("ins", null, "aggiuntivo"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("del", null, "cancellato"), " o ", /* @__PURE__ */ React.createElement("s", null, "invalido"), "."), /* @__PURE__ */ React.createElement("p", null, "Esempio di testo ", /* @__PURE__ */ React.createElement("code", null, "monospace"), "."))
};
const RobotoMono = {
  render: () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", {
