...
import { p as pick, o as omit } from "./utils-DNvasP3d.js";
import { T as Transition } from "./Transition-DOLYtmQu.js";
const Accordion = ({
  tag = "div",
  className,
  background,
...
const AccordionBody = ({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    (status) => {
      ...
      return /* @__PURE__ */ React.createElement(Tag, { className: classes, style: { ...childProps.style, ...style }, ...childProps }, /* @__PURE__ */ React.createElement("div", { className: listClasses }, children));
    }
  );
};
...
const AccordionHeader = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "accordion-header", "data-testid": testId }, /* @__PURE__ */ React.createElement(
    Tag,
    {
...
const AccordionItem = ({ tag = "div", className, ...attributes }) => {
  ...
  return /* @__PURE__ */ React.createElement(Tag, { ...attributes, className: classes });
};
...
const GruppiDiElementiRichiudibiliWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(Accordion, null, /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "1",
    onToggle: () => setCollapseElement(collapseElementOpen !== "1" ? "1" : "")
  }, "Elemento Richiudibile #1"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "1"
  }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch.")), /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "2",
    onToggle: () => setCollapseElement(collapseElementOpen !== "2" ? "2" : "")
  }, "Elemento Richiudibile #2"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "2"
  }, "Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.")), /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "3",
    onToggle: () => setCollapseElement(collapseElementOpen !== "3" ? "3" : "")
  }, "Elemento Richiudibile #3"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "3"
...
const GruppiDiElementiRichiudibili = {
  render: () => /* @__PURE__ */ React.createElement(GruppiDiElementiRichiudibiliWithHooks, null)
};
const _AccordionWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(Accordion, null, /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "1",
    onToggle: () => setCollapseElement(collapseElementOpen !== "1" ? "1" : "")
  }, "Accordion Group Item #1"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "1",
    listClassName: "custom-class"
  }, "Vestibulum hendrerit ultrices nibh, sed pharetra lacus ultrices eget. Morbi et ipsum et sapien dapibus facilisis. Integer eget semper nibh. Proin enim nulla, egestas ac rutrum eget, ullamcorper nec turpis.")), /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "2",
    onToggle: () => setCollapseElement(collapseElementOpen !== "2" ? "2" : "")
  }, "Accordion Group Item #2"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "2",
    listClassName: "custom-class"
  }, "Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.")), /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "3",
    onToggle: () => setCollapseElement(collapseElementOpen !== "3" ? "3" : "")
  }, "Accordion Group Item #3"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "3",
    listClassName: "custom-class"
  }, "Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.")));
};
const _Accordion = {
  render: () => /* @__PURE__ */ React.createElement(_AccordionWithHooks, null)
};
const AccordionAnnidatiWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(Accordion, null, /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "1",
    onToggle: () => setCollapseElement(collapseElementOpen !== "1" ? "1" : "")
  }, "Elemento Accordion #1"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "1"
  }, /* @__PURE__ */ React.createElement(Accordion, null, /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: nestedCollapseOpen === "1",
    onToggle: () => setNestedCollapseOpen(nestedCollapseOpen !== "1" ? "1" : "")
  }, "Elemento Accordion annidato #1"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: nestedCollapseOpen === "1"
  }, "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch.")), /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: nestedCollapseOpen === "2",
    onToggle: () => setNestedCollapseOpen(nestedCollapseOpen !== "2" ? "2" : "")
  }, "Elemento Accordion annidato #2"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: nestedCollapseOpen === "2"
  }, "Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.")), /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: nestedCollapseOpen === "3",
    onToggle: () => setNestedCollapseOpen(nestedCollapseOpen !== "3" ? "3" : "")
  }, "Elemento Accordion annidato #3"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: nestedCollapseOpen === "3"
  }, "Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident."))))), /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "2",
    onToggle: () => setCollapseElement(collapseElementOpen !== "2" ? "2" : "")
  }, "Elemento Accordion #2"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "2"
  }, "Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS."), /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "3",
    onToggle: () => setCollapseElement(collapseElementOpen !== "3" ? "3" : "")
  }, "Elemento Accordion #3"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "3"
  }, "Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident."));
};
const AccordionAnnidati = {
  render: () => /* @__PURE__ */ React.createElement(AccordionAnnidatiWithHooks, null)
};
const HeaderAttiviWithHooks = () => {
  const [collapseElementOpen, setCollapseElement] = reactExports.useState("");
  return /* @__PURE__ */ React.createElement(Accordion, {
    background: "active"
  }, /* @__PURE__ */ React.createElement(AccordionItem, null, /* @__PURE__ */ React.createElement(AccordionHeader, {
    active: collapseElementOpen === "1",
    onToggle: () => setCollapseElement(collapseElementOpen !== "1" ? "1" : "")
  }, "Elemento Accordion #1"), /* @__PURE__ */ React.createElement(AccordionBody, {
    active: collapseElementOpen === "1"
...
const HeaderAttivi = {
  render: () => /* @__PURE__ */ React.createElement(HeaderAttiviWithHooks, null)
};
...
const HeaderHover = {
  render: () => /* @__PURE__ */ React.createElement(HeaderHoverWithHooks, null)
};
...
const IconaSinistra = {
  render: () => /* @__PURE__ */ React.createElement(IconaSinistraWithHooks, null)
};
