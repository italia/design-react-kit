...
import { n as noop } from "./utils-DNvasP3d.js";
...
const Rating = ({
  ...
  const legendContent = isCustomLegendObject(legend) || isLegendString ? /* @__PURE__ */ React.createElement("legend", { className: legendClass }, legendText) : legend;
  return /* @__PURE__ */ React.createElement(
    ...
    safeInputs.map((id, i) => {
      ...
      return /* @__PURE__ */ React.createElement(reactExports.Fragment, { key: id }, /* @__PURE__ */ React.createElement(
        Input,
        {
          type: "radio",
          id,
      ...
      ), /* @__PURE__ */ React.createElement(Label, { className: "full", for: id }, /* @__PURE__ */ React.createElement(Icon, { icon: "it-star-full", size: "sm" }), /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, labelFn(currentValue))));
    })
  );
};
...
const RatingConLabelWithHooks = () => {
  ...
  return /* @__PURE__ */ React.createElement(Rating, {
    value: rating,
    legend: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", {
      className: "visually-hidden"
    }, "Valutazione"), " ", /* @__PURE__ */ React.createElement("span", null, rating, " stelle"), /* @__PURE__ */ React.createElement("span", {
      className: "visually-hidden"
    }, "su 5")),
...
const RatingConLabel = {
  render: () => /* @__PURE__ */ React.createElement(RatingConLabelWithHooks, null),
  parameters: {
    docs: {
      canvas: {
        sourceState: "none"
...
const RatingReadOnly = {
  render: () => /* @__PURE__ */ React.createElement(Rating, {
    value: 4,
    readOnly: true,
    legend: {
