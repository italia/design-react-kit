const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./react-18-DYU-8ZWV.js","./index-N7T0HPyM.js","./_commonjsHelpers-CcAunmGO.js","./client-DfJhxb-N.js","./index-_6PbV05F.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./iframe-71tjp26B.js";
import { _ as __toESM, a as __commonJS, d as __export } from "./chunk-XP5HYGXS-CQBei2qV.js";
...
var require_re = __commonJS({ "../../node_modules/semver/internal/re.js"(exports, module) {
  ...
  var re = exports.re = [], safeRe = exports.safeRe = [], src = exports.src = [], safeSrc = exports.safeSrc = [], t2 = exports.t = {}, R2 = 0, LETTERDASHNUMBER = "[a-zA-Z0-9-]", safeRegexReplacements = [["\\s", 1], ["\\d", MAX_LENGTH], [LETTERDASHNUMBER, MAX_SAFE_BUILD_LENGTH]], makeSafeRegex = (value) => {
    ...
    debug(name, index, value), t2[name] = index, src[index] = value, safeSrc[index] = safe, re[index] = new RegExp(value, isGlobal ? "g" : void 0), safeRe[index] = new RegExp(safe, isGlobal ? "g" : void 0);
  };
...
var require_semver = __commonJS({ "../../node_modules/semver/classes/semver.js"(exports, module) {
  var debug = require_debug(), { MAX_LENGTH, MAX_SAFE_INTEGER } = require_constants(), { safeRe: re, safeSrc: src, t: t2 } = require_re(), parseOptions = require_parse_options(), { compareIdentifiers } = require_identifiers(), SemVer = class _SemVer {
    ...
    inc(release, identifier, identifierBase) {
      if (release.startsWith("pre")) {
        ...
        if (identifier) {
          let r2 = new RegExp(`^${this.options.loose ? src[t2.PRERELEASELOOSE] : src[t2.PRERELEASE]}$`), match = `-${identifier}`.match(r2);
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await __vitePreload(async () => {
    const { renderElement: renderElement2, unmountElement: unmountElement2 } = await import("./react-18-DYU-8ZWV.js");
    return { renderElement: renderElement2, unmountElement: unmountElement2 };
  }, true ? __vite__mapDeps([0,1,2,3,4]) : void 0, import.meta.url), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? e.createElement(Story, { ...storyContext }) : e.createElement(ErrorBoundary, { showMain, showException }, e.createElement(Story, { ...storyContext })), element = Wrapper ? e.createElement(Wrapper, null, content) : content;
...
var parameters = { renderer: "react" }, decorators = [(story, context) => {
  ...
  try {
    let { configure } = await __vitePreload(async () => {
      const { configure: configure2 } = await import("./index-CVCQkCk7.js").then((n2) => n2.a);
