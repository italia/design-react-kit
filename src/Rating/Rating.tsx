...
export interface RatingProps extends InputProps {
...
function isCustomLegendObject(legend: ReactNode | {content: ReactNode, srOnly: boolean}): legend is {content: ReactNode, srOnly: boolean} {
