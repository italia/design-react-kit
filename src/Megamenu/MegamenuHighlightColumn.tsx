...
export interface MegamenuHighlightColumnProps extends HTMLAttributes<HTMLDivElement> {
...
export const MegamenuHighlightColumn: FC<MegamenuHighlightColumnProps> = ({
  description,
  className,
  children,
  ...attributes
