...
export const Badge: FC<BadgeProps> = ({color = 'secondary', pill = false, tag='span', children, ...attributes}) => {
  return <BadgeReact color={color} pill={pill} tag={tag} {...attributes}>{children}</BadgeReact>
}
