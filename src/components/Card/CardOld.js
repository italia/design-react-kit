...
class Card extends React.Component {
  render() {
    ...
    const cardWrapperClasses = classNames('card-wrapper',
      { 'card-space': this.props.hasSpace }
    )
    const innerCardWrapperClasses = classNames('card', {
      'card-bg': this.props.hasShade, 
      'card-big': this.props.isBig,
      'card-img': this.props.imageSrc,
      'special-card': this.props.isSpecialCard,
      'no-after': this.props.after
    })
